# SAP: Projects and Services Livewire

## Canonical one-to-one Livewire 4 implementation

**Livewire package:** `module-sap-projects-and-services-livewire`  
...
- **Portfolios:** interactive component state, validation feedback, loading, and failure recovery for this domain capability.
...
- Register a stable `module-sap-projects-and-services-livewire` component namespace and service provider; use explicit aliases such as `<livewire:module-sap-projects-and-services::component-name />` according to LIVEWIRE.md.
...
- `portfolios`: expose a focused Livewire 4 component or full-page component backed by the corresponding domain query/action.
...
- Package identity, namespace, aliases, and dependency match `sap-projects-and-services` one-to-one.
