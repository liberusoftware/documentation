# Automation: Image Livewire

## Canonical one-to-one Livewire 4 implementation

**Livewire package:** `module-automation-image-livewire`  
...
- **Generation/editing requests:** interactive component state, validation feedback, loading, and failure recovery for this domain capability.
- **Source assets:** interactive component state, validation feedback, loading, and failure recovery for this domain capability.
...
- Register a stable `module-automation-image-livewire` component namespace and service provider; use explicit aliases such as `<livewire:module-automation-image::component-name />` according to LIVEWIRE.md.
...
- `generation/editing-requests`: expose a focused Livewire 4 component or full-page component backed by the corresponding domain query/action.
- `source-assets`: expose a focused Livewire 4 component or full-page component backed by the corresponding domain query/action.
...
- Package identity, namespace, aliases, and dependency match `automation-image` one-to-one.
