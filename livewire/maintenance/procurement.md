# Maintenance: Procurement Livewire

## Canonical one-to-one Livewire 4 implementation

**Livewire package:** `module-maintenance-procurement-livewire`  
...
- Register a stable `module-maintenance-procurement-livewire` component namespace and service provider; use explicit aliases such as `<livewire:module-maintenance-procurement::component-name />` according to LIVEWIRE.md.
...
- Package identity, namespace, aliases, and dependency match `maintenance-procurement` one-to-one.
