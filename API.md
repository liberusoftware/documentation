...
**Related standards:** [MODULES.md](MODULES.md) · [BOILERPLATE.md](BOILERPLATE.md) · [THEMES.md](THEMES.md) · [REPOSITORIES.md](REPOSITORIES.md) · [DOCUMENTATION.md](DOCUMENTATION.md) · [TESTING.md](TESTING.md)
...
This document defines the shared API contract. Product scopes define which resources and actions exist. `MODULES.md` defines package ownership and dependency direction. `BOILERPLATE.md` owns identity, tokens, service identities, scopes, rate-limit infrastructure, webhooks, audit, and integrations.
