# Control Panel: Control Core React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-control-panel-control-core-react-inertia`
**Matching domain module:** `control-panel-control-core`
**Application:** Control Panel
**Source feature:** [Control Core](../../features/control-panel/control-core.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/control-panel/control-core.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-control-panel-control-core-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `task-engine`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `inventory`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `desired-state`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
