# Control Panel: Monitoring React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-control-panel-monitoring-react-inertia`
**Matching domain module:** `control-panel-monitoring`
**Application:** Control Panel
**Source feature:** [Monitoring](../../features/control-panel/monitoring.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/control-panel/monitoring.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-control-panel-monitoring-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `metrics`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `logs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `uptime`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `maintenance-windows`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
