# SAP: Finance React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-sap-finance-react-inertia`
**Matching domain module:** `sap-finance`
**Application:** SAP
**Source feature:** [Finance](../../features/sap/finance.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/sap/finance.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-sap-finance-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `general-ledger`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `receivables`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `payables`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `banking`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `treasury`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `consolidation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
