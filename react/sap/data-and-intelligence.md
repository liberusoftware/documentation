# SAP: Data and Intelligence React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-sap-data-and-intelligence-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/sap/data-and-intelligence.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
