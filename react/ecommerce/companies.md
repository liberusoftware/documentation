# Ecommerce: Companies React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-companies-react-inertia`
**Matching domain module:** `ecommerce-companies`
**Application:** Ecommerce
**Source feature:** [Companies](../../features/ecommerce/companies.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/companies.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Company accounts/locations:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- **Approvers:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Sales reps:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Tax/exemption:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-ecommerce-companies-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `company-accounts-locations`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `approvers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `sales-reps`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `tax-exemption`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `payment-terms`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
