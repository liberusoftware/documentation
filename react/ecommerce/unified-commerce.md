# Ecommerce: Unified Commerce React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-unified-commerce-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/unified-commerce.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-unified-commerce-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `shared-customer`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `loyalty`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `promotions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `fulfillment-across-online-pos-channels`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
