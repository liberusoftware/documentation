# Ecommerce: Carrier Operations React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-carrier-operations-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/carrier-operations.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Tracking:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Address validation:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Claims:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Delivery events:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-ecommerce-carrier-operations-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `pickup`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `manifests`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `tracking`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `address-validation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `claims`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `delivery-events`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
