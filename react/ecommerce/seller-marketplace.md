# Ecommerce: Seller Marketplace React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-seller-marketplace-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/seller-marketplace.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-seller-marketplace-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `sellers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `offers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `catalog-contributions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `portal`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
