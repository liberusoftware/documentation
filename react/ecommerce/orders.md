# Ecommerce: Orders React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-orders-react-inertia`
**Matching domain module:** `ecommerce-orders`
**Application:** Ecommerce
**Source feature:** [Orders](../../features/ecommerce/orders.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/orders.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Immutable product/price/tax/discount/address/terms snapshots:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **State machine:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-ecommerce-orders-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `immutable-product-price-tax-discount-address-terms-snapshots`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `state-machine`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- Package identity, public exports, API dependency, and module dependency match `ecommerce-orders` one-to-one.
