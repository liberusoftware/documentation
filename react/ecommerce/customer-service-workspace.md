# Ecommerce: Customer Service Workspace React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-customer-service-workspace-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/customer-service-workspace.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-customer-service-workspace-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `shipments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `returns`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `customer-timeline`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `safe-actions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `crm-support-handoff`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
