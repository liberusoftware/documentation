# Ecommerce: Sandbox and Release React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-sandbox-and-release-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/sandbox-and-release.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-sandbox-and-release-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `test-stores-data-policy`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `configuration-catalog-snapshots`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `dependency-comparison`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `staging`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `smoke-tests`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
