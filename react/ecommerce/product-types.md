# Ecommerce: Product Types React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-product-types-react-inertia`
**Matching domain module:** `ecommerce-product-types`
**Application:** Ecommerce
**Source feature:** [Product Types](../../features/ecommerce/product-types.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/product-types.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-product-types-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `simple`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `configurable-variant`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `grouped`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `bundle`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `kit`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `virtual`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `downloadable`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `service`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `subscription`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `gift-card`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `custom-type-contracts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
