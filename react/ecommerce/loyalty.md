# Ecommerce: Loyalty React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-loyalty-react-inertia`
**Matching domain module:** `ecommerce-loyalty`
**Application:** Ecommerce
**Source feature:** [Loyalty](../../features/ecommerce/loyalty.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/loyalty.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-loyalty-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `earn-redeem`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `customer-statements`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
