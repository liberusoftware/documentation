# Ecommerce: Membership Commerce React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-membership-commerce-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/membership-commerce.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-membership-commerce-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `membership-products`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `member-pricing-content`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
