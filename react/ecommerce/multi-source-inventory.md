# Ecommerce: Multi-Source Inventory React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-multi-source-inventory-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/ecommerce/multi-source-inventory.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-ecommerce-multi-source-inventory-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `sources-warehouses-stores-drop-shippers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `stocks`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `channel-assignment`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `aggregated-salable-quantity`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `priority-distance-rules`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
