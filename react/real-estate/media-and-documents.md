# Real Estate: Media and Documents React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-real-estate-media-and-documents-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/real-estate/media-and-documents.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-real-estate-media-and-documents-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `photos`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `floorplans`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
