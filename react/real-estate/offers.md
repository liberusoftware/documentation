# Real Estate: Offers React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-real-estate-offers-react-inertia`
**Matching domain module:** `real-estate-offers`
**Application:** Real Estate
**Source feature:** [Offers](../../features/real-estate/offers.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/real-estate/offers.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-real-estate-offers-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `accepted-offer-controls`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
