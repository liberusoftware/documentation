# CRM: SLA and Entitlements React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-sla-and-entitlements-react-inertia`
**Matching domain module:** `crm-sla-and-entitlements`
**Application:** CRM
**Source feature:** [SLA and Entitlements](../../features/crm/sla-and-entitlements.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/sla-and-entitlements.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-sla-and-entitlements-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `service-contracts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `coverage`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `business-calendars`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `response-resolution-targets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `milestones`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `pauses`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `warnings`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `breaches`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `escalations`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
