# CRM: CRM Analytics React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-analytics-react-inertia`
**Matching domain module:** `crm-analytics`
**Application:** CRM
**Source feature:** [CRM Analytics](../../features/crm/crm-analytics.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/crm-analytics.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-analytics-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `governed-datasets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `pivots`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `row-level-access`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `metric-lineage`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
