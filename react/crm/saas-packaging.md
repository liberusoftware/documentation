# CRM: SaaS Packaging React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-saas-packaging-react-inertia`
**Matching domain module:** `crm-saas-packaging`
**Application:** CRM
**Source feature:** [SaaS Packaging](../../features/crm/saas-packaging.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/saas-packaging.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-saas-packaging-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `feature-module-entitlements`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `signup-provisioning`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `billing-integration`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
