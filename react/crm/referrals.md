# CRM: Referrals React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-referrals-react-inertia`
**Matching domain module:** `crm-referrals`
**Application:** CRM
**Source feature:** [Referrals](../../features/crm/referrals.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/referrals.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Referral programs:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Links/codes:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Advocates:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Prospects:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- **Fraud/duplicate controls:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-crm-referrals-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `referral-programs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `links-codes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `advocates`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `prospects`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `fraud-duplicate-controls`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
