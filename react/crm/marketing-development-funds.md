# CRM: Marketing Development Funds React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-marketing-development-funds-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/marketing-development-funds.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Reimbursements:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-crm-marketing-development-funds-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `reimbursements`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
