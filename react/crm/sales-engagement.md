# CRM: Sales Engagement React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-sales-engagement-react-inertia`
**Matching domain module:** `crm-sales-engagement`
**Application:** CRM
**Source feature:** [Sales Engagement](../../features/crm/sales-engagement.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/sales-engagement.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-sales-engagement-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `sequences-cadences`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `multi-channel-steps`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `templates-snippets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `task-queues`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `enrollment-re-entry`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `throttles`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `timezone-windows`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `reply-meeting-stop-rules`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
