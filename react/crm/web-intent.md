# CRM: Web Intent React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-web-intent-react-inertia`
**Matching domain module:** `crm-web-intent`
**Application:** CRM
**Source feature:** [Web Intent](../../features/crm/web-intent.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/web-intent.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-web-intent-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `first-party-visits`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `account-identification-adapters`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `page-content-engagement`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `scoring-signals`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `alerts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `buyer-intent`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `consent`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `lead-account-conversion`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
