# CRM: Reputation Management React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-crm-reputation-management-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/crm/reputation-management.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-crm-reputation-management-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `review-requests`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `review-site-connections`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `monitoring`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `response-workflow`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `sentiment`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `location-rollups`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `reputation-reporting`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
