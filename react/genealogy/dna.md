# Genealogy: DNA React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-genealogy-dna-react-inertia`
**Matching domain module:** `genealogy-dna`
**Application:** Genealogy
**Source feature:** [DNA](../../features/genealogy/dna.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/genealogy/dna.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-genealogy-dna-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `kits`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `match-segments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `relationships`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `groups`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
