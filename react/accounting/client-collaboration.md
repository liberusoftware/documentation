# Accounting: Client Collaboration React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-client-collaboration-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/accounting/client-collaboration.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-accounting-client-collaboration-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `secure-document-requests`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
