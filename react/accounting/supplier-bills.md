# Accounting: Supplier Bills React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-supplier-bills-react-inertia`
**Matching domain module:** `accounting-supplier-bills`
**Application:** Accounting
**Source feature:** [Supplier Bills](../../features/accounting/supplier-bills.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/accounting/supplier-bills.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-accounting-supplier-bills-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `draft-approved-posted-bills`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `capture-sources`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `line-coding`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
