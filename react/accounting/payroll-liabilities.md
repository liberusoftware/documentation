# Accounting: Payroll Liabilities React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-payroll-liabilities-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/accounting/payroll-liabilities.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Agency/payee balances:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-accounting-payroll-liabilities-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `agency-payee-balances`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- Package identity, public exports, API dependency, and module dependency match `accounting-payroll-liabilities` one-to-one.
