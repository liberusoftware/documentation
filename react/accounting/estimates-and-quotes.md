# Accounting: Estimates and Quotes React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-estimates-and-quotes-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/accounting/estimates-and-quotes.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-accounting-estimates-and-quotes-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `branded-estimates-quotes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `acceptance-decline`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
