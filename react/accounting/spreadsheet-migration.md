# Accounting: Spreadsheet Migration React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-spreadsheet-migration-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/accounting/spreadsheet-migration.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-accounting-spreadsheet-migration-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `guided-mapping`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `opening-outstanding-detail-modes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `balancing`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `duplicate-controls`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
