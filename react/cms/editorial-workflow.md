# CMS: Editorial Workflow React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-editorial-workflow-react-inertia`
**Matching domain module:** `cms-editorial-workflow`
**Application:** CMS
**Source feature:** [Editorial Workflow](../../features/cms/editorial-workflow.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/cms/editorial-workflow.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Configurable states/transitions:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-cms-editorial-workflow-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `configurable-states-transitions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
