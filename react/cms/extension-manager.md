# CMS: Extension Manager React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-extension-manager-react-inertia`
**Matching domain module:** `cms-extension-manager`
**Application:** CMS
**Source feature:** [Extension Manager](../../features/cms/extension-manager.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/cms/extension-manager.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-cms-extension-manager-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `install-enable-disable-update-uninstall`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `migrations`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
