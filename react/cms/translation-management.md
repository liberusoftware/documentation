# CMS: Translation Management React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-translation-management-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/cms/translation-management.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-cms-translation-management-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `jobs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `source-changes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `assignments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `vendor-adapters`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `machine-translation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `review`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `memory-glossaries`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
