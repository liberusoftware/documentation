# CMS: Web Delivery React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-web-delivery-react-inertia`
**Matching domain module:** `cms-web-delivery`
**Application:** CMS
**Source feature:** [Web Delivery](../../features/cms/web-delivery.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/cms/web-delivery.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-cms-web-delivery-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `canonical-route-rendering`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `response-metadata`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `cache-tags`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `preview-mode`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `edge-invalidation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
