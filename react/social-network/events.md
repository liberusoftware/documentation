# Social Network: Events React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-social-network-events-react-inertia`
**Matching domain module:** `social-network-events`
**Application:** Social Network
**Source feature:** [Events](../../features/social-network/events.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/social-network/events.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-social-network-events-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
