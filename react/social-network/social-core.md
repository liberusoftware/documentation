# Social Network: Social Core React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-social-network-social-core-react-inertia`
**Matching domain module:** `social-network-social-core`
**Application:** Social Network
**Source feature:** [Social Core](../../features/social-network/social-core.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/social-network/social-core.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-social-network-social-core-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `network-settings`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `deployment-mode`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `terminology`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `feature-policy`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `shared-ids`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
