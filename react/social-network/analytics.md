# Social Network: Analytics React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-social-network-analytics-react-inertia`
**Matching domain module:** `social-network-analytics`
**Application:** Social Network
**Source feature:** [Analytics](../../features/social-network/analytics.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/social-network/analytics.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-social-network-analytics-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `growth`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `privacy-governed-insights`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
