# Billing: Catalog React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-billing-catalog-react-inertia`
**Matching domain module:** `billing-catalog`
**Application:** Billing
**Source feature:** [Catalog](../../features/billing/catalog.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/billing/catalog.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- **Configurable options:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-billing-catalog-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `configurable-options`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- Package identity, public exports, API dependency, and module dependency match `billing-catalog` one-to-one.
