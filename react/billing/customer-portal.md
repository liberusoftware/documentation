# Billing: Customer Portal React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-billing-customer-portal-react-inertia`
**Matching domain module:** `billing-customer-portal`
**Application:** Billing
**Source feature:** [Customer Portal](../../features/billing/customer-portal.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/billing/customer-portal.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-billing-customer-portal-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `tickets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
