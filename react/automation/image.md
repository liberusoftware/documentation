# Automation: Image React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-automation-image-react-inertia`
**Matching domain module:** `automation-image`
**Application:** Automation
**Source feature:** [Image](../../features/automation/image.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/automation/image.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-automation-image-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `generation-editing-requests`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `source-assets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
