# Automation: Prompt Registry React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-automation-prompt-registry-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/automation/prompt-registry.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-automation-prompt-registry-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `versioned-prompts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `variables`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `evaluation-sets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `brand-tenant-overrides`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
