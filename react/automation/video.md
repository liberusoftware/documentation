# Automation: Video React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-automation-video-react-inertia`
**Matching domain module:** `automation-video`
**Application:** Automation
**Source feature:** [Video](../../features/automation/video.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/automation/video.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-automation-video-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `generation-editing-jobs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
