# Maintenance: Customers and Sites React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-maintenance-customers-and-sites-react-inertia`
...
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/maintenance/customers-and-sites.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-maintenance-customers-and-sites-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `access-details`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `hazards`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `service-windows`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
