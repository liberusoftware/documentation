# Maintenance: Procurement React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-maintenance-procurement-react-inertia`
**Matching domain module:** `maintenance-procurement`
**Application:** Maintenance
**Source feature:** [Procurement](../../features/maintenance/procurement.md)
**Architecture:** [REACT.md](../../REACT.md) · [API.md](../../API.md) · [Matching API module](../../api/maintenance/procurement.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)
...
- Register a stable `module-maintenance-procurement-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
