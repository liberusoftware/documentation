...
**Architecture:** [MODULES.md](MODULES.md) · [BOILERPLATE.md](BOILERPLATE.md) · [THEMES.md](THEMES.md) · [API.md](API.md)
...
| Shared application foundation | [BOILERPLATE.md](BOILERPLATE.md) |
...
Source: [BOILERPLATE.md](BOILERPLATE.md)
