# Notifications AND Subscriptions — end-user guide

**Project:** [Liberu CMS](../README.md)
**Feature specification:** [notifications-and-subscriptions.md](../../../../projects/cms/features/notifications-and-subscriptions.md)
**Shared experience standard:** [Web and mobile](../../../WEB-AND-MOBILE.md)

## What users see

See content status, preview, audience, and publishing confidence. The module should explain its purpose in the page heading, keep related evidence close to the decision, and never require users to understand internal package names.
