# Liberu Enterprise Resource Planning — end-user guide

**Experience area:** Enterprise operations
**Canonical developer scope:** [SAP.md](../../../projects/sap/SAP.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Teams see role-specific work centers, approvals, master data, operational exceptions, financial impact, and governed reporting.
...
See [all enterprise operations module experiences](modules/README.md).
