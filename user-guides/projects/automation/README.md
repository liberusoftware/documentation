# Liberu Automation — end-user guide

**Experience area:** Automation and AI
**Canonical developer scope:** [AUTOMATION.md](../../../projects/automation/AUTOMATION.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Users see safe recipes, pending approvals, run history, explanations, and recoverable failures—not opaque autonomous behavior.
...
See [all automation and ai module experiences](modules/README.md).
