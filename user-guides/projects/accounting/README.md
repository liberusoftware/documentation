# Liberu Accounting — end-user guide

**Experience area:** Finance
**Canonical developer scope:** [ACCOUNTING.md](../../../projects/accounting/ACCOUNTING.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Users see a calm money workspace: balances, invoices, bills, approvals, reconciliation, reports, and clear period status.
...
See [all finance module experiences](modules/README.md).
