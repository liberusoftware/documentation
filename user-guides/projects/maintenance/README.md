# Liberu Maintenance — end-user guide

**Experience area:** Assets and field work
**Canonical developer scope:** [MAINTENANCE.md](../../../projects/maintenance/MAINTENANCE.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Technicians see an actionable route: assigned work, asset history, checklists, parts, evidence, safety, and completion.
...
See [all assets and field work module experiences](modules/README.md).
