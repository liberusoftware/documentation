# Moderation AND Analytics — end-user guide

**Project:** [Liberu Browser Game](../README.md)
**Feature specification:** [moderation-and-analytics.md](../../../../projects/browser-game/features/moderation-and-analytics.md)
**Shared experience standard:** [Web and mobile](../../../WEB-AND-MOBILE.md)

## What users see

See world context, available action, consequence, and progress. The module should explain its purpose in the page heading, keep related evidence close to the decision, and never require users to understand internal package names.
