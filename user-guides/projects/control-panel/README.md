# Liberu Control Panel — end-user guide

**Experience area:** Hosting operations
**Canonical developer scope:** [CONTROL-PANEL.md](../../../projects/control-panel/CONTROL-PANEL.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Customers and operators see service health, resources, deployments, DNS, mail, backups, incidents, and safe action confirmation.
...
See [all hosting operations module experiences](modules/README.md).
