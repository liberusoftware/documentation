# API AND Automation — end-user guide

**Project:** [Liberu Control Panel](../README.md)
**Feature specification:** [api-and-automation.md](../../../../projects/control-panel/features/api-and-automation.md)
**Shared experience standard:** [Web and mobile](../../../WEB-AND-MOBILE.md)

## What users see

See service health, impact, evidence, and the safest recovery action. The module should explain its purpose in the page heading, keep related evidence close to the decision, and never require users to understand internal package names.
