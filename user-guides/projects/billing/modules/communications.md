# Communications — end-user guide

**Project:** [Liberu Billing](../README.md)
**Feature specification:** [communications.md](../../../../projects/billing/features/communications.md)
**Shared experience standard:** [Web and mobile](../../../WEB-AND-MOBILE.md)

## What users see

See amount, period, status, and the next safe payment or account action. The module should explain its purpose in the page heading, keep related evidence close to the decision, and never require users to understand internal package names.
