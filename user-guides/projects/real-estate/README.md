# Liberu Real Estate — end-user guide

**Experience area:** Property
**Canonical developer scope:** [REAL-ESTATE.md](../../../projects/real-estate/REAL-ESTATE.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Visitors see search and enquiry; agents see listings, viewings, offers, progression, landlord/tenant communication, and portal tasks.
...
See [all property module experiences](modules/README.md).
