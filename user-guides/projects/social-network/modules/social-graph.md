# Social Graph — end-user guide

**Project:** [Liberu Social Network](../README.md)
**Feature specification:** [social-graph.md](../../../../projects/social-network/features/social-graph.md)
**Shared experience standard:** [Web and mobile](../../../WEB-AND-MOBILE.md)

## What users see

See people and community context, participation controls, and moderation/reporting. The module should explain its purpose in the page heading, keep related evidence close to the decision, and never require users to understand internal package names.
