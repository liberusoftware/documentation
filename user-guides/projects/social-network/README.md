# Liberu Social Network — end-user guide

**Experience area:** Community
**Canonical developer scope:** [SOCIAL-NETWORK.md](../../../projects/social-network/SOCIAL-NETWORK.md)
**All module journeys:** [Module guides](modules/README.md)

## What users should feel

Members see a welcoming feed, profiles, groups, messaging, discovery, events, moderation signals, and control over their data.
...
See [all community module experiences](modules/README.md).
