# Liberu Business Platform — end-user guide
...
Customers experience one coherent path across official websites, CRM, support, hosting/services, billing, and mobile self-service.
...
See [all cross-product platform module experiences](modules/README.md).
