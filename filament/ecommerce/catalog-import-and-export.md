# Ecommerce: Catalog Import and Export Filament

## Canonical one-to-one Filament 5 implementation

**Filament package:** `module-ecommerce-catalog-import-and-export-filament`  
...
This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the `ecommerce-catalog-import-and-export` public boundary. It must not contain another module's UI or depend on application `App\` classes.

## 2. Module-specific surfaces

- **Schemas:** resource/table/form/action or page behavior for this module's authorized workflow.
...
- **Media/relationship resolution:** resource/table/form/action or page behavior for this module's authorized workflow.
...
- Register a stable `module-ecommerce-catalog-import-and-export-filament` plugin and discover only classes in this package's namespace; applications attach it explicitly to each eligible panel.
...
- `schemas`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- `media/relationship-resolution`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- Package identity, namespace, plugin ID, and dependency match `ecommerce-catalog-import-and-export` one-to-one.
