...
**Filament package:** `module-genealogy-dna-filament`  
...
- **Kits:** resource/table/form/action or page behavior for this module's authorized workflow.
...
- **Match segments:** resource/table/form/action or page behavior for this module's authorized workflow.
- **Relationships:** resource/table/form/action or page behavior for this module's authorized workflow.
- **Groups:** resource/table/form/action or page behavior for this module's authorized workflow.
...
- Register a stable `module-genealogy-dna-filament` plugin and discover only classes in this package's namespace; applications attach it explicitly to each eligible panel.
...
- `kits`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- `match-segments`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
- `relationships`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
- `groups`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- Package identity, namespace, plugin ID, and dependency match `genealogy-dna` one-to-one.
