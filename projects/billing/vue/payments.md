# Billing: Payments Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-billing-payments-vue-inertia`
...
- Register a stable `module-billing-payments-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `mandates`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `gateway-drivers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `capture`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
