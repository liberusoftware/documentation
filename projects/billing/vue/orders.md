# Billing: Orders Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-billing-orders-vue-inertia`
...
- Register a stable `module-billing-orders-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `checkout`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `fraud-review`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `agreements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `order-state`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `change-orders`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
