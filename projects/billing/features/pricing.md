...
**Domain module:** `module-billing-pricing`
**Application:** Billing  
...
The Pricing module owns Recurring/one-time/usage/tiered pricing, contracts, discounts, proration, and snapshots. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Recurring/one-time/usage/tiered pricing:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Proration:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-billing-pricing-filament`, `module-billing-pricing-livewire`, and `module-billing-pricing-api`.
...
- Verify recurring/one-time/usage/tiered pricing across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify proration across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
