...
**Architecture:** Modules follow [MODULES.md](../../architecture/MODULES.md); APIs, payment/provisioning connectors, and webhooks follow [API.md](../../architecture/API.md); storefront and portal presentation follows [THEMES.md](../../architecture/THEMES.md).
