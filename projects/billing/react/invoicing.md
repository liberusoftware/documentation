# Billing: Invoicing React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-billing-invoicing-react-inertia`
**Matching domain module:** `billing-invoicing`
**Application:** Billing
**Source feature:** [Invoicing](../features/invoicing.md)
**Architecture:** [REACT.md](../BILLING.md) · [API.md](../BILLING.md) · [Matching API module](../api/invoicing.md) · [MODULES.md](../BILLING.md) · [TESTING.md](../BILLING.md)
...
- **Line generation:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- **Finalization:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.

## 3. React 19.2 + Inertia 3 implementation

- Register a stable `module-billing-invoicing-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `line-generation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `finalization`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- Package identity, public exports, API dependency, and module dependency match `billing-invoicing` one-to-one.
