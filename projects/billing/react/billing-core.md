# Billing: Billing Core React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-billing-core-react-inertia`
**Matching domain module:** `billing-core`
**Application:** Billing
**Source feature:** [Billing Core](../features/billing-core.md)
**Architecture:** [REACT.md](../BILLING.md) · [API.md](../BILLING.md) · [Matching API module](../api/billing-core.md) · [MODULES.md](../BILLING.md) · [TESTING.md](../BILLING.md)
...
- Register a stable `module-billing-core-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `tax-profiles`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `sequences`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `terms`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `billing-settings`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
