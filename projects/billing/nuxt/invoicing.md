# Billing: Invoicing Nuxt

## Canonical one-to-one Nuxt 4 implementation

**Nuxt package:** `module-billing-invoicing-nuxt`
**Matching domain module:** `billing-invoicing`
**Application:** Billing
**Source feature:** [Invoicing](../features/invoicing.md)
**Architecture:** [NUXT.md](../BILLING.md) · [API.md](../BILLING.md) · [Matching API module](../api/invoicing.md) · [MODULES.md](../BILLING.md) · [TESTING.md](../BILLING.md)

## 1. Purpose and ownership

This optional Nuxt 4 presentation package presents exactly one matching API module. It contributes reusable pages, layouts, components, composables, typed API clients, and actions to application-owned Nuxt applications while delegating authorization, validation, team context, persistence, and business rules to the `billing-invoicing` public API boundary. It must not contain another module's UI or depend on application `App\` classes.

## 2. Module-specific surfaces

- **Schedules:** page/component/composable/API-action behavior for this module's authorized workflow.
- **Line generation:** page/component/composable/API-action behavior for this module's authorized workflow.
...
- **Finalization:** page/component/composable/API-action behavior for this module's authorized workflow.

## 3. Nuxt 4 implementation

- Register a stable `module-billing-invoicing-nuxt` Nuxt module or layer and expose only prefixed exports from this package; applications compose it explicitly.
...
- `line-generation`: map the API query/action to the appropriate Nuxt page, component, composable, or typed API action.
...
- `finalization`: map the API query/action to the appropriate Nuxt page, component, composable, or typed API action.
