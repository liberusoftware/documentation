# Accounting: Tax Returns React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-tax-returns-react-inertia`
**Matching domain module:** `accounting-tax-returns`
**Application:** Accounting
**Source feature:** [Tax Returns](../features/tax-returns.md)
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/tax-returns.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-tax-returns-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `return-preparation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `source-reconciliation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `submission-adapter`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `receipt-status`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
