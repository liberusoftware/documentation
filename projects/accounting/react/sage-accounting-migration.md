# Accounting: Sage Accounting Migration React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-sage-accounting-migration-react-inertia`
...
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/sage-accounting-migration.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-sage-accounting-migration-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `chart-analysis-types`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `sales-purchases`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `payments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `bank`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `vat-cis-evidence`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
