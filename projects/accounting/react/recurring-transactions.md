# Accounting: Recurring Transactions React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-recurring-transactions-react-inertia`
...
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/recurring-transactions.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- **Date/amount rules:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Approval:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Draft/automatic generation:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-accounting-recurring-transactions-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `date-amount-rules`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `approval`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `draft-automatic-generation`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- Package identity, public exports, API dependency, and module dependency match `accounting-recurring-transactions` one-to-one.
