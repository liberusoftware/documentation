# Accounting: Payroll Journals React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-payroll-journals-react-inertia`
**Matching domain module:** `accounting-payroll-journals`
**Application:** Accounting
**Source feature:** [Payroll Journals](../features/payroll-journals.md)
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/payroll-journals.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-payroll-journals-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `gross-pay`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `benefits`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `employer-costs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `net-pay`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `reversal`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
