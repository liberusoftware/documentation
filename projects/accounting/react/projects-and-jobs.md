# Accounting: Projects and Jobs React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-projects-and-jobs-react-inertia`
**Matching domain module:** `accounting-projects-and-jobs`
**Application:** Accounting
**Source feature:** [Projects and Jobs](../features/projects-and-jobs.md)
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/projects-and-jobs.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-projects-and-jobs-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `project-job-hierarchy`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `managers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `source-links`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
