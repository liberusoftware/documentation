# Accounting: Operational Reports React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-operational-reports-react-inertia`
...
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/operational-reports.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-operational-reports-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `receivables-payables`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `assets`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `payroll`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `exception-reports`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
