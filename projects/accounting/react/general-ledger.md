# Accounting: General Ledger React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-general-ledger-react-inertia`
**Matching domain module:** `accounting-general-ledger`
**Application:** Accounting
**Source feature:** [General Ledger](../features/general-ledger.md)
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/general-ledger.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-general-ledger-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `balanced-postings`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `recurring-journals`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `reversals`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `accruals`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `prepayments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
