# Accounting: Revenue Recognition React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-revenue-recognition-react-inertia`
...
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/revenue-recognition.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-revenue-recognition-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `obligations-schedules`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `allocation-references`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `deferred-accrued-revenue`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `recognition-runs`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `modifications`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `reconciliation-(optional)`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
