# Accounting: Withholding Tax React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-accounting-withholding-tax-react-inertia`
**Matching domain module:** `accounting-withholding-tax`
**Application:** Accounting
**Source feature:** [Withholding Tax](../features/withholding-tax.md)
**Architecture:** [REACT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/withholding-tax.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- Register a stable `module-accounting-withholding-tax-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `supplier-customer-deductions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `regional-filing-adapters`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
