# Accounting: Customer Payments Nuxt

## Canonical one-to-one Nuxt 4 implementation

**Nuxt package:** `module-accounting-customer-payments-nuxt`
**Matching domain module:** `accounting-customer-payments`
**Application:** Accounting
**Source feature:** [Customer Payments](../features/customer-payments.md)
**Architecture:** [NUXT.md](../ACCOUNTING.md) · [API.md](../ACCOUNTING.md) · [Matching API module](../api/customer-payments.md) · [MODULES.md](../ACCOUNTING.md) · [TESTING.md](../ACCOUNTING.md)
...
- **Gateway/bank references:** page/component/composable/API-action behavior for this module's authorized workflow.
...
- **Partial/overpayments:** page/component/composable/API-action behavior for this module's authorized workflow.
...
- Register a stable `module-accounting-customer-payments-nuxt` Nuxt module or layer and expose only prefixed exports from this package; applications compose it explicitly.
...
- `gateway/bank-references`: map the API query/action to the appropriate Nuxt page, component, composable, or typed API action.
...
- `partial/overpayments`: map the API query/action to the appropriate Nuxt page, component, composable, or typed API action.
