# Accounting: Close Management Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-close-management-vue-inertia`
**Matching domain module:** `accounting-close-management`
**Application:** Accounting
**Source feature:** [Close Management](../features/close-management.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/close-management.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-close-management-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `checklist`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `reconciliations`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
