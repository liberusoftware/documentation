# Accounting: KPI and Goals Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-kpi-and-goals-vue-inertia`
**Matching domain module:** `accounting-kpi-and-goals`
**Application:** Accounting
**Source feature:** [KPI and Goals](../features/kpi-and-goals.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/kpi-and-goals.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-kpi-and-goals-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `commentary`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
