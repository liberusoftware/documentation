# Accounting: Recurring Transactions Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-recurring-transactions-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/recurring-transactions.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-recurring-transactions-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `date-amount-rules`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `approval`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `draft-automatic-generation`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
