# Accounting: Payroll Liabilities Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-payroll-liabilities-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/payroll-liabilities.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-payroll-liabilities-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `agency-payee-balances`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
