# Accounting: QuickBooks Online Migration Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-quickbooks-online-migration-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/quickbooks-online-migration.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-quickbooks-online-migration-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `chart`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `classes-locations`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `bank-data`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
