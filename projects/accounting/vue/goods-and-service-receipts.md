# Accounting: Goods and Service Receipts Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-goods-and-service-receipts-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/goods-and-service-receipts.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-goods-and-service-receipts-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `service-confirmation`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `inventory-project-references`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `accrual-events`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
