# Accounting: Bank Feeds Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-bank-feeds-vue-inertia`
**Matching domain module:** `accounting-bank-feeds`
**Application:** Accounting
**Source feature:** [Bank Feeds](../features/bank-feeds.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/bank-feeds.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-bank-feeds-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `consent-connections`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `institutions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `account-mapping`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `cursors`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `pending-posted-state`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
