# Accounting: Accountant Workspace Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-accounting-accountant-workspace-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/accountant-workspace.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-accounting-accountant-workspace-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `client-entity-portfolio`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `recent-changes`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
