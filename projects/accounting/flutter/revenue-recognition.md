# Revenue Recognition Flutter + Dart

**Package:** module-accounting-revenue-recognition-flutter
**Matching core package:** module-accounting-revenue-recognition ([implementation](../core/revenue-recognition.md))
**Matching API package:** module-accounting-revenue-recognition-api ([contract](../api/revenue-recognition.md))

## Implementation plan

This adapter presents Revenue Recognition for the Flutter + Dart surface. It owns platform UI, navigation/state integration, device-facing behavior, and client error/recovery mapping; the matching core package remains authoritative for domain rules, persistence, authorization, tenancy, audit, and lifecycle transitions.
...
Test Revenue Recognition API mapping, authorization outcomes, state transitions, lifecycle interruption, permission denial, offline/retry/conflict behavior, accessibility, localization, and signed release builds on supported platforms.

See [Flutter + Dart standard](../../../standards/FLUTTER.md), [mobile architecture](../../../architecture/MOBILE.md), [Flutter + Dart technology](../../../technologies/FLUTTER.md), [core module](../core/revenue-recognition.md), and [API module](../api/revenue-recognition.md).
