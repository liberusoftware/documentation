# Sales Tax And Gst Flutter + Dart

**Package:** module-accounting-sales-tax-and-gst-flutter
...
This adapter presents Sales Tax And Gst for the Flutter + Dart surface. It owns platform UI, navigation/state integration, device-facing behavior, and client error/recovery mapping; the matching core package remains authoritative for domain rules, persistence, authorization, tenancy, audit, and lifecycle transitions.
...
See [Flutter + Dart standard](../../../standards/FLUTTER.md), [mobile architecture](../../../architecture/MOBILE.md), [Flutter + Dart technology](../../../technologies/FLUTTER.md), [core module](../core/sales-tax-and-gst.md), and [API module](../api/sales-tax-and-gst.md).
