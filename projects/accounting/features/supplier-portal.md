# Accounting: Supplier Portal

## Canonical independent module specification

**Domain module:** `module-accounting-supplier-portal`
...
The Supplier Portal module owns Profile/bank-change requests, purchase orders, invoices, statements, disputes, payment status, and secure documents. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Profile/bank-change requests:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Payment status:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Secure documents:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-supplier-portal-filament`, `module-accounting-supplier-portal-livewire`, and `module-accounting-supplier-portal-api`.
...
- Verify profile/bank-change requests across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify payment status across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify secure documents across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
