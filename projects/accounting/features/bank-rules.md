...
**Domain module:** `module-accounting-bank-rules`
...
The Bank Rules module owns Payee/text/amount/account conditions, split/category/tax/dimension actions, priority, suggestions/automation, testing, and history. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Payee/text/amount/account conditions:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Split/category/tax/dimension actions:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Suggestions/automation:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-bank-rules-filament`, `module-accounting-bank-rules-livewire`, and `module-accounting-bank-rules-api`.
...
- Verify payee/text/amount/account conditions across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify split/category/tax/dimension actions across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify suggestions/automation across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
