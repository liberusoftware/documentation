...
The Accountant Workspace module owns Client/entity portfolio, status, deadlines, alerts, access, notes, requests, recent changes, and drill-through. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Client/entity portfolio:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Recent changes:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-accountant-workspace-filament`, `module-accounting-accountant-workspace-livewire`, and `module-accounting-accountant-workspace-api`.
...
- Verify client/entity portfolio across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify recent changes across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
