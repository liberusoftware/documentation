...
**Domain module:** `module-accounting-recurring-transactions`
...
The Recurring Transactions module owns Templates, schedules, date/amount rules, approval, draft/automatic generation, exceptions, expiry, and history. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Date/amount rules:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Draft/automatic generation:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-recurring-transactions-filament`, `module-accounting-recurring-transactions-livewire`, and `module-accounting-recurring-transactions-api`.
...
- Verify date/amount rules across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify draft/automatic generation across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
