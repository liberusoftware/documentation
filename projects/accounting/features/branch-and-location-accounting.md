# Accounting: Branch and Location Accounting
...
The Branch and Location Accounting module owns Branch/location dimensions or books, local sequences/tax, allocations, performance, and statutory requirements. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Branch/location dimensions or books:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Local sequences/tax:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Statutory requirements:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-branch-and-location-accounting-filament`, `module-accounting-branch-and-location-accounting-livewire`, and `module-accounting-branch-and-location-accounting-api`.
...
- Verify branch/location dimensions or books across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify local sequences/tax across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify statutory requirements across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
