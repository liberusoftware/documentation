...
**Domain module:** `module-accounting-chart-of-accounts`
...
The Chart of Accounts module owns Account types, codes, hierarchies, control accounts, normal balances, templates, restrictions, localization, and lifecycle. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Account types:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Normal balances:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-chart-of-accounts-filament`, `module-accounting-chart-of-accounts-livewire`, and `module-accounting-chart-of-accounts-api`.
...
- Verify account types across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify normal balances across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
