# Accounting: Matching Intelligence

## Canonical independent module specification

**Domain module:** `module-accounting-matching-intelligence`
...
The Matching Intelligence module owns Bank/document/payment/settlement matching suggestions, confidence, evidence, feedback, and safe automation thresholds. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Bank/document/payment/settlement matching suggestions:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Safe automation thresholds:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-matching-intelligence-filament`, `module-accounting-matching-intelligence-livewire`, and `module-accounting-matching-intelligence-api`.
...
- Verify bank/document/payment/settlement matching suggestions across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify safe automation thresholds across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
