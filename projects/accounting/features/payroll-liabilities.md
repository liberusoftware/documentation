...
**Domain module:** `module-accounting-payroll-liabilities`
...
The Payroll Liabilities module owns Agency/payee balances, due dates, payments, allocations, exceptions, and reconciliation. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Agency/payee balances:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-payroll-liabilities-filament`, `module-accounting-payroll-liabilities-livewire`, and `module-accounting-payroll-liabilities-api`.
...
- Verify agency/payee balances across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
