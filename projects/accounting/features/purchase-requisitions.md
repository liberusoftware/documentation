...
**Domain module:** `module-accounting-purchase-requisitions`
...
The Purchase Requisitions module owns Requests, coding, budgets, attachments, approvals, sourcing handoff, conversion, and status. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Coding:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Sourcing handoff:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-purchase-requisitions-filament`, `module-accounting-purchase-requisitions-livewire`, and `module-accounting-purchase-requisitions-api`.
...
- Verify coding across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify sourcing handoff across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
