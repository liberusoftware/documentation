# Accounting: Job Estimates

## Canonical independent module specification

**Domain module:** `module-accounting-job-estimates`
...
The Job Estimates module owns Cost/revenue estimates, quantities/rates, versions, approvals, actual comparison, and estimate-at-completion. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Cost/revenue estimates:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Quantities/rates:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Estimate-at-completion:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-accounting-job-estimates-filament`, `module-accounting-job-estimates-livewire`, and `module-accounting-job-estimates-api`.
...
- Verify cost/revenue estimates across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify quantities/rates across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify estimate-at-completion across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
