# Accounting: Sales Tax And Gst Core Module

## Package contract

**Composer package:** `module-accounting-sales-tax-and-gst`
**Domain specification:** [Sales Tax And Gst](../features/sales-tax-and-gst.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sales Tax And Gst. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
