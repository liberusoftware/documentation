# Accounting: Product And Service Items Core Module

## Package contract

**Composer package:** `module-accounting-product-and-service-items`
**Domain specification:** [Product And Service Items](../features/product-and-service-items.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Product And Service Items. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
