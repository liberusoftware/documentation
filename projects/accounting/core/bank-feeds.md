# Accounting: Bank Feeds Core Module

## Package contract

**Composer package:** `module-accounting-bank-feeds`
**Domain specification:** [Bank Feeds](../features/bank-feeds.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Bank Feeds. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
