# Accounting: Kpi And Goals Core Module

## Package contract

**Composer package:** `module-accounting-kpi-and-goals`
**Domain specification:** [Kpi And Goals](../features/kpi-and-goals.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Kpi And Goals. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
