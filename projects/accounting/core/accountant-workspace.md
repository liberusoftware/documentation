# Accounting: Accountant Workspace Core Module

## Package contract

**Composer package:** `module-accounting-accountant-workspace`
**Domain specification:** [Accountant Workspace](../features/accountant-workspace.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Accountant Workspace. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
