# Accounting: Sage Accounting Migration Core Module

## Package contract

**Composer package:** `module-accounting-sage-accounting-migration`
**Domain specification:** [Sage Accounting Migration](../features/sage-accounting-migration.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sage Accounting Migration. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
