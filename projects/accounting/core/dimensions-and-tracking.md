# Accounting: Dimensions And Tracking Core Module

## Package contract

**Composer package:** `module-accounting-dimensions-and-tracking`
**Domain specification:** [Dimensions And Tracking](../features/dimensions-and-tracking.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Dimensions And Tracking. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
