# Accounting: Business Insights Core Module

## Package contract

**Composer package:** `module-accounting-business-insights`
**Domain specification:** [Business Insights](../features/business-insights.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Business Insights. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
