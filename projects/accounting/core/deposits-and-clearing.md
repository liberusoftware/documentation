# Accounting: Deposits And Clearing Core Module

## Package contract

**Composer package:** `module-accounting-deposits-and-clearing`
**Domain specification:** [Deposits And Clearing](../features/deposits-and-clearing.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Deposits And Clearing. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
