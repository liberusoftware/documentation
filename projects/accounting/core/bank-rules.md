...
This package is the authoritative, provider-neutral implementation of Bank Rules. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
