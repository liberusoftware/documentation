# Accounting: Branch And Location Accounting Core Module

## Package contract

**Composer package:** `module-accounting-branch-and-location-accounting`
**Domain specification:** [Branch And Location Accounting](../features/branch-and-location-accounting.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Branch And Location Accounting. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
