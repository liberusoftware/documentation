# Accounting: Inventory Accounting Core Module

## Package contract

**Composer package:** `module-accounting-inventory-accounting`
**Domain specification:** [Inventory Accounting](../features/inventory-accounting.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Inventory Accounting. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
