# Accounting: Regional Packs Core Module

## Package contract

**Composer package:** `module-accounting-regional-packs`
**Domain specification:** [Regional Packs](../features/regional-packs.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Regional Packs. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
