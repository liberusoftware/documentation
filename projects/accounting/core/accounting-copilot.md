# Accounting: Accounting Copilot Core Module

## Package contract

**Composer package:** `module-accounting-accounting-copilot`
**Domain specification:** [Accounting Copilot](../features/accounting-copilot.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Accounting Copilot. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
