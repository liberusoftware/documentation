# Accounting: Custom Report Builder Core Module

## Package contract

**Composer package:** `module-accounting-custom-report-builder`
**Domain specification:** [Custom Report Builder](../features/custom-report-builder.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Custom Report Builder. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
