# Accounting: Credit Notes And Adjustments Core Module

## Package contract

**Composer package:** `module-accounting-credit-notes-and-adjustments`
**Domain specification:** [Credit Notes And Adjustments](../features/credit-notes-and-adjustments.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Credit Notes And Adjustments. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
