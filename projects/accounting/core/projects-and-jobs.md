# Accounting: Projects And Jobs Core Module

## Package contract

**Composer package:** `module-accounting-projects-and-jobs`
**Domain specification:** [Projects And Jobs](../features/projects-and-jobs.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Projects And Jobs. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
