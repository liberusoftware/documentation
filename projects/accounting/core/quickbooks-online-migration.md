# Accounting: Quickbooks Online Migration Core Module

## Package contract

**Composer package:** `module-accounting-quickbooks-online-migration`
**Domain specification:** [Quickbooks Online Migration](../features/quickbooks-online-migration.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Quickbooks Online Migration. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
