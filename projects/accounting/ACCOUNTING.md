...
**Architecture:** Packages and provider adapters follow [MODULES.md](../../architecture/MODULES.md); APIs, connectors, and webhooks follow [API.md](../../architecture/API.md); business, accountant, approval, and portal interfaces follow [THEMES.md](../../standards/THEMES.md).
