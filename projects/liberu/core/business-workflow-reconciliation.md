# Liberu: Business Workflow Reconciliation Core Module

## Package contract

**Composer package:** `module-liberu-business-workflow-reconciliation`
**Domain specification:** [Business Workflow Reconciliation](../features/business-workflow-reconciliation.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Business Workflow Reconciliation. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
