# Liberu: Platform Orchestration Core Module

## Package contract

**Composer package:** `module-liberu-platform-orchestration`
**Domain specification:** [Platform Orchestration](../features/platform-orchestration.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Platform Orchestration. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
