...
**Domain module:** `module-real-estate-viewings`
...
The Viewings module owns Availability, booking, confirmation, access, accompaniment, reminders, feedback, and no-shows. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Accompaniment:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **No-shows:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-real-estate-viewings-filament`, `module-real-estate-viewings-livewire`, and `module-real-estate-viewings-api`.
...
- Verify accompaniment across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify no-shows across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
