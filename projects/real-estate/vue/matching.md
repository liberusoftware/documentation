# Real Estate: Matching Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-real-estate-matching-vue-inertia`
**Matching domain module:** `real-estate-matching`
**Application:** Real Estate
**Source feature:** [Matching](../features/matching.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/matching.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-real-estate-matching-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `applicant-requirements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `affordability`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `preferences`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `scoring`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
