# Real Estate: Portals and Reporting Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-real-estate-portals-and-reporting-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/portals-and-reporting.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-real-estate-portals-and-reporting-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `party-self-service-plus-pipeline`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `conversion`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `source`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `fee`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `time-to-complete`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `occupancy`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
