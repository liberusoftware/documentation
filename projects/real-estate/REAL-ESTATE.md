...
**Architecture:** Modules follow [MODULES.md](../../architecture/MODULES.md); portal, property, and marketplace connector APIs follow [API.md](../../architecture/API.md); agent, vendor, landlord, tenant, and applicant interfaces follow [THEMES.md](../../architecture/THEMES.md).
