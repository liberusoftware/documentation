# Real Estate: Media And Documents Core Module

## Package contract

**Composer package:** `module-real-estate-media-and-documents`
**Domain specification:** [Media And Documents](../features/media-and-documents.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Media And Documents. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
