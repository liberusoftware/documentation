# Real Estate: Real Estate Core Core Module

## Package contract

**Composer package:** `module-real-estate-real-estate-core`
**Domain specification:** [Real Estate Core](../features/real-estate-core.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Real Estate Core. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
