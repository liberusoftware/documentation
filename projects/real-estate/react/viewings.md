# Real Estate: Viewings React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-real-estate-viewings-react-inertia`
**Matching domain module:** `real-estate-viewings`
**Application:** Real Estate
**Source feature:** [Viewings](../features/viewings.md)
**Architecture:** [REACT.md](../REAL-ESTATE.md) · [API.md](../REAL-ESTATE.md) · [Matching API module](../api/viewings.md) · [MODULES.md](../REAL-ESTATE.md) · [TESTING.md](../REAL-ESTATE.md)
...
- Register a stable `module-real-estate-viewings-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `accompaniment`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `no-shows`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
