# Real Estate: Sales Progression React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-real-estate-sales-progression-react-inertia`
...
**Architecture:** [REACT.md](../REAL-ESTATE.md) · [API.md](../REAL-ESTATE.md) · [Matching API module](../api/sales-progression.md) · [MODULES.md](../REAL-ESTATE.md) · [TESTING.md](../REAL-ESTATE.md)
...
- Register a stable `module-real-estate-sales-progression-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `chain`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `milestones`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `memoranda`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `legal-finance-contacts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `completion`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
