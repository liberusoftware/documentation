# Real Estate: Real Estate Core React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-real-estate-core-react-inertia`
...
**Architecture:** [REACT.md](../REAL-ESTATE.md) · [API.md](../REAL-ESTATE.md) · [Matching API module](../api/real-estate-core.md) · [MODULES.md](../REAL-ESTATE.md) · [TESTING.md](../REAL-ESTATE.md)
...
- **Agencies:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Branches:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-real-estate-core-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `agencies`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `branches`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
