# Crm: Orders And Payments Workspace Core Module

## Package contract

**Composer package:** `module-crm-orders-and-payments-workspace`
**Domain specification:** [Orders And Payments Workspace](../features/orders-and-payments-workspace.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Orders And Payments Workspace. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
