# Crm: Quotas And Incentives Core Module

## Package contract

**Composer package:** `module-crm-quotas-and-incentives`
**Domain specification:** [Quotas And Incentives](../features/quotas-and-incentives.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Quotas And Incentives. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
