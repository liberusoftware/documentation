# Crm: Crm Automation Pack Core Module

## Package contract

**Composer package:** `module-crm-crm-automation-pack`
**Domain specification:** [Crm Automation Pack](../features/crm-automation-pack.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Crm Automation Pack. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
