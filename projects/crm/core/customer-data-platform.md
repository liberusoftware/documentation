# Crm: Customer Data Platform Core Module

## Package contract

**Composer package:** `module-crm-customer-data-platform`
**Domain specification:** [Customer Data Platform](../features/customer-data-platform.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Customer Data Platform. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
