# Crm: Feedback And Voice Of Customer Core Module

## Package contract

**Composer package:** `module-crm-feedback-and-voice-of-customer`
**Domain specification:** [Feedback And Voice Of Customer](../features/feedback-and-voice-of-customer.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Feedback And Voice Of Customer. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
