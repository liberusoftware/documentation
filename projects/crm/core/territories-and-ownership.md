# Crm: Territories And Ownership Core Module

## Package contract

**Composer package:** `module-crm-territories-and-ownership`
**Domain specification:** [Territories And Ownership](../features/territories-and-ownership.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Territories And Ownership. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
