# Crm: Email Productivity Core Module

## Package contract

**Composer package:** `module-crm-email-productivity`
**Domain specification:** [Email Productivity](../features/email-productivity.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Email Productivity. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
