# Crm: Proposals And Quotes Core Module

## Package contract

**Composer package:** `module-crm-proposals-and-quotes`
**Domain specification:** [Proposals And Quotes](../features/proposals-and-quotes.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Proposals And Quotes. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
