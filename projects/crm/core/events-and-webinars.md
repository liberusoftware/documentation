# Crm: Events And Webinars Core Module

## Package contract

**Composer package:** `module-crm-events-and-webinars`
**Domain specification:** [Events And Webinars](../features/events-and-webinars.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Events And Webinars. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
