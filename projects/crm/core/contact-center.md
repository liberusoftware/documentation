# Crm: Contact Center Core Module

## Package contract

**Composer package:** `module-crm-contact-center`
**Domain specification:** [Contact Center](../features/contact-center.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Contact Center. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
