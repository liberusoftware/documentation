# Crm: Marketing Resources Core Module

## Package contract

**Composer package:** `module-crm-marketing-resources`
**Domain specification:** [Marketing Resources](../features/marketing-resources.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Marketing Resources. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
