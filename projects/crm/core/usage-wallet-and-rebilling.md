# Crm: Usage Wallet And Rebilling Core Module

## Package contract

**Composer package:** `module-crm-usage-wallet-and-rebilling`
**Domain specification:** [Usage Wallet And Rebilling](../features/usage-wallet-and-rebilling.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Usage Wallet And Rebilling. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
