# Crm: Lead Capture Core Module

## Package contract

**Composer package:** `module-crm-lead-capture`
**Domain specification:** [Lead Capture](../features/lead-capture.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Lead Capture. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
