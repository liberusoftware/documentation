# Crm: Sandbox And Release Management Core Module

## Package contract

**Composer package:** `module-crm-sandbox-and-release-management`
**Domain specification:** [Sandbox And Release Management](../features/sandbox-and-release-management.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sandbox And Release Management. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
