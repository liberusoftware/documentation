# Crm: Conversion Optimization Core Module

## Package contract

**Composer package:** `module-crm-conversion-optimization`
**Domain specification:** [Conversion Optimization](../features/conversion-optimization.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Conversion Optimization. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
