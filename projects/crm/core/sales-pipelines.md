# Crm: Sales Pipelines Core Module

## Package contract

**Composer package:** `module-crm-sales-pipelines`
**Domain specification:** [Sales Pipelines](../features/sales-pipelines.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sales Pipelines. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
