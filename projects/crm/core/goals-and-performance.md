# Crm: Goals And Performance Core Module

## Package contract

**Composer package:** `module-crm-goals-and-performance`
**Domain specification:** [Goals And Performance](../features/goals-and-performance.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Goals And Performance. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
