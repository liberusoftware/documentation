# Crm: Sla And Entitlements Core Module

## Package contract

**Composer package:** `module-crm-sla-and-entitlements`
**Domain specification:** [Sla And Entitlements](../features/sla-and-entitlements.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sla And Entitlements. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
