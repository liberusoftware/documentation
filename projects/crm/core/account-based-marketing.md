# Crm: Account Based Marketing Core Module

## Package contract

**Composer package:** `module-crm-account-based-marketing`
**Domain specification:** [Account Based Marketing](../features/account-based-marketing.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Account Based Marketing. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
