# Crm: Marketing Development Funds Core Module

## Package contract

**Composer package:** `module-crm-marketing-development-funds`
**Domain specification:** [Marketing Development Funds](../features/marketing-development-funds.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Marketing Development Funds. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
