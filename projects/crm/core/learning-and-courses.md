# Crm: Learning And Courses Core Module

## Package contract

**Composer package:** `module-crm-learning-and-courses`
**Domain specification:** [Learning And Courses](../features/learning-and-courses.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Learning And Courses. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
