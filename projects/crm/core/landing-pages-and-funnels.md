# Crm: Landing Pages And Funnels Core Module

## Package contract

**Composer package:** `module-crm-landing-pages-and-funnels`
**Domain specification:** [Landing Pages And Funnels](../features/landing-pages-and-funnels.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Landing Pages And Funnels. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
