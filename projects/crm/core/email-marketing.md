# Crm: Email Marketing Core Module

## Package contract

**Composer package:** `module-crm-email-marketing`
**Domain specification:** [Email Marketing](../features/email-marketing.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Email Marketing. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
