# Crm: Dialer And Outreach Core Module

## Package contract

**Composer package:** `module-crm-dialer-and-outreach`
**Domain specification:** [Dialer And Outreach](../features/dialer-and-outreach.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Dialer And Outreach. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
