# Crm: Web Intent Core Module

## Package contract

**Composer package:** `module-crm-web-intent`
**Domain specification:** [Web Intent](../features/web-intent.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Web Intent. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
