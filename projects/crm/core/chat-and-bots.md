# Crm: Chat And Bots Core Module

## Package contract

**Composer package:** `module-crm-chat-and-bots`
**Domain specification:** [Chat And Bots](../features/chat-and-bots.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Chat And Bots. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
