# Crm: Playbooks And Enablement Core Module

## Package contract

**Composer package:** `module-crm-playbooks-and-enablement`
**Domain specification:** [Playbooks And Enablement](../features/playbooks-and-enablement.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Playbooks And Enablement. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
