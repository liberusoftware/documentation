...
**Architecture:** Packages and provider adapters follow [MODULES.md](../../architecture/MODULES.md); APIs, marketplace connectors, and webhooks follow [API.md](../../architecture/API.md); staff, partner, and customer experiences follow [THEMES.md](../../architecture/THEMES.md).
