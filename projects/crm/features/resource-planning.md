...
The Resource Planning module owns Skills, capacity, allocation, utilization, tentative/confirmed bookings, conflicts, rates, and staffing forecasts. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Tentative/confirmed bookings:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Staffing forecasts:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-crm-resource-planning-filament`, `module-crm-resource-planning-livewire`, and `module-crm-resource-planning-api`.
...
- Verify tentative/confirmed bookings across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify staffing forecasts across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
