# CRM: Channel Sales Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-channel-sales-vue-inertia`
**Matching domain module:** `crm-channel-sales`
**Application:** CRM
**Source feature:** [Channel Sales](../features/channel-sales.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/channel-sales.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-channel-sales-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `partner-opportunities`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `shared-pipelines`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `referrals`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `reseller-pricing-references`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `quotes-orders-handoff`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `commissions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `forecasts`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `partner-portal`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
