# CRM: Projects Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-projects-vue-inertia`
**Matching domain module:** `crm-projects`
**Application:** CRM
**Source feature:** [Projects](../features/projects.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/projects.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-projects-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `post-sale-projects`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `client-visibility`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `opportunity-handoff`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
