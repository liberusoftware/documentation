# CRM: Predictive Models Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-predictive-models-vue-inertia`
**Matching domain module:** `crm-predictive-models`
**Application:** CRM
**Source feature:** [Predictive Models](../features/predictive-models.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/predictive-models.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-predictive-models-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
