# CRM: Templates and Snapshots Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-templates-and-snapshots-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/templates-and-snapshots.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-templates-and-snapshots-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `versioned-bundles-of-fields`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `settings-with-preview`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `protected-sharing`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `install`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `update`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
