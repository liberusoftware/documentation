# CRM: Memberships Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-memberships-vue-inertia`
**Matching domain module:** `crm-memberships`
**Application:** CRM
**Source feature:** [Memberships](../features/memberships.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/memberships.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-memberships-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `membership-plans`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `gated-resources`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `community-course-bundles`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `member-portal`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
