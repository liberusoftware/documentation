# CRM: Learning and Courses Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-learning-and-courses-vue-inertia`
**Matching domain module:** `crm-learning-and-courses`
**Application:** CRM
**Source feature:** [Learning and Courses](../features/learning-and-courses.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/learning-and-courses.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-learning-and-courses-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `courses`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `lessons`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `enrollment`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `assessments`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `product-contract-entitlements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
