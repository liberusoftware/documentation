# CRM: Contact Center Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-contact-center-vue-inertia`
**Matching domain module:** `crm-contact-center`
**Application:** CRM
**Source feature:** [Contact Center](../features/contact-center.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/contact-center.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-contact-center-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `agent-presence`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `supervisor-views`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `whisper-barge-policy`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `quality-review`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `workforce-demand`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `queue-sla`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `overflow`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
