# CRM: Lead Capture Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-lead-capture-vue-inertia`
**Matching domain module:** `crm-lead-capture`
**Application:** CRM
**Source feature:** [Lead Capture](../features/lead-capture.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/lead-capture.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-lead-capture-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `leads-inbox`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `manual-import-api-capture`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `forms`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `surveys`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `qr-codes`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `chat`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `calls`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `advertisements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `source-metadata`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
