# CRM: Customer Self-Service Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-customer-self-service-vue-inertia`
**Matching domain module:** `crm-customer-self-service`
**Application:** CRM
**Source feature:** [Customer Self-Service](../features/customer-self-service.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/customer-self-service.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-customer-self-service-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `customer-portal`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `case-submission-status`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `knowledge-search`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `community-links`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `appointments`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `documents`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `invoices-orders-references`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
