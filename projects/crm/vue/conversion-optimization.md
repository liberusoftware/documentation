# CRM: Conversion Optimization Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-conversion-optimization-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/conversion-optimization.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-crm-conversion-optimization-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `a-b-and-multivariate-tests`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `traffic-allocation`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `goals`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `statistical-policy`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `popups`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `banners`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `ctas`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `personalization-rules`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `experiment-reporting`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
