# CRM: Loyalty Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-crm-loyalty-vue-inertia`
...
- Register a stable `module-crm-loyalty-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `earning-redemption-rules`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `partner-activity`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `member-statements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
