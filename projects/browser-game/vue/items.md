# Browser Game: Items Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-browser-game-items-vue-inertia`
**Matching domain module:** `browser-game-items`
**Application:** Browser Game
**Source feature:** [Items](../features/items.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/items.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-browser-game-items-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `durability`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `binding`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `containers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `stack-rules`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
