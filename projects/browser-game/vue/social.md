# Browser Game: Social Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-browser-game-social-vue-inertia`
**Matching domain module:** `browser-game-social`
**Application:** Browser Game
**Source feature:** [Social](../features/social.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/social.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-browser-game-social-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `friends`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `mail`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `guilds`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `alliances`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
