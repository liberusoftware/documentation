...
**Architecture:** Game capabilities follow [MODULES.md](../../architecture/MODULES.md); game, administration, and integration APIs follow [API.md](../../architecture/API.md); player/admin presentation and media follow [THEMES.md](../../architecture/THEMES.md).
