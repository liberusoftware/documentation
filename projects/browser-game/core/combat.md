# Browser Game: Combat Core Module

## Package contract

**Composer package:** `module-browser-game-combat`
**Domain specification:** [Combat](../features/combat.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Combat. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
