# Control Panel: Api And Automation Core Module

## Package contract

**Composer package:** `module-control-panel-api-and-automation`
**Domain specification:** [Api And Automation](../features/api-and-automation.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Api And Automation. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
