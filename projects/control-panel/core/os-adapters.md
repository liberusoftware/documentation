# Control Panel: Os Adapters Core Module

## Package contract

**Composer package:** `module-control-panel-os-adapters`
**Domain specification:** [Os Adapters](../features/os-adapters.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Os Adapters. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
