# Control Panel: Backups Core Module

## Package contract

**Composer package:** `module-control-panel-backups`
**Domain specification:** [Backups](../features/backups.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Backups. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
