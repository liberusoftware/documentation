# Control Panel: Web Hosting Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-control-panel-web-hosting-vue-inertia`
**Matching domain module:** `control-panel-web-hosting`
**Application:** Control Panel
**Source feature:** [Web Hosting](../features/web-hosting.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/web-hosting.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-control-panel-web-hosting-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `virtual-hosts`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `php-runtime-versions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `web-servers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
