...
components:
  ...
  schemas:
    ControlPanelWebHostingResource:
      type: object
      ...
      properties:
        ...
        type:
          type: string
          const: control-panel-web-hosting
        attributes:
          type: object
    ...
    ResourceCollection:
      ...
      properties:
        data:
          type: array
          items:
            $ref: "#/components/schemas/ControlPanelWebHostingResource"
  responses:
    ResourceCollection:
...
- Add one-to-one architecture tests proving this package depends on and presents only `control-panel-web-hosting`.
...
- The package name, manifest, Composer dependency, namespace, route prefix, and OpenAPI ownership all match `control-panel-web-hosting`.
