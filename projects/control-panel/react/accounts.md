# Control Panel: Accounts React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-control-panel-accounts-react-inertia`
**Matching domain module:** `control-panel-accounts`
**Application:** Control Panel
**Source feature:** [Accounts](../features/accounts.md)
**Architecture:** [REACT.md](../CONTROL-PANEL.md) · [API.md](../CONTROL-PANEL.md) · [Matching API module](../api/accounts.md) · [MODULES.md](../CONTROL-PANEL.md) · [TESTING.md](../CONTROL-PANEL.md)
...
- **Admin/reseller/customer hierarchy:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-control-panel-accounts-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `admin-reseller-customer-hierarchy`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
