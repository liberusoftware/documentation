...
**Domain module:** `module-control-panel-accounts`
...
The Accounts module owns Admin/reseller/customer hierarchy, packages, quotas, delegation, branding, and suspension. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Admin/reseller/customer hierarchy:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Delegation:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-control-panel-accounts-filament`, `module-control-panel-accounts-livewire`, and `module-control-panel-accounts-api`.
...
- Verify admin/reseller/customer hierarchy across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify delegation across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
