# Genealogy: Collaboration Filament

## Canonical one-to-one Filament 5 implementation

**Filament package:** `module-genealogy-collaboration-filament`  
...
- **Branch/change proposals:** resource/table/form/action or page behavior for this module's authorized workflow.
...
- **Watch lists:** resource/table/form/action or page behavior for this module's authorized workflow.
- **Attribution:** resource/table/form/action or page behavior for this module's authorized workflow.

## 3. Filament 5 implementation

- Register a stable `module-genealogy-collaboration-filament` plugin and discover only classes in this package's namespace; applications attach it explicitly to each eligible panel.
...
- `branch/change-proposals`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- `watch-lists`: map the domain query/action to the appropriate Filament 5 resource, page, widget, or action.
...
- Package identity, namespace, plugin ID, and dependency match `genealogy-collaboration` one-to-one.
