# Genealogy: Research Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-genealogy-research-vue-inertia`
**Matching domain module:** `genealogy-research`
**Application:** Genealogy
**Source feature:** [Research](../features/research.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/research.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-genealogy-research-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `correspondence`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `negative-searches`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `findings`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
