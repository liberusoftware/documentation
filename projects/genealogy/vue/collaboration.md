# Genealogy: Collaboration Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-genealogy-collaboration-vue-inertia`
...
- Register a stable `module-genealogy-collaboration-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `branch-change-proposals`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `watch-lists`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
