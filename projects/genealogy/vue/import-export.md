# Genealogy: Import Export Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-genealogy-import-export-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/import-export.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-genealogy-import-export-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `gedcom-and-gramps-mapping`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `round-trip`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
