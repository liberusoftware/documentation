# Boilerplate: Sessions and Devices React presentation packages

**Composer package:** `module-sessions-and-devices-react`
...
This package presents the Sessions and Devices core capability through React. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
