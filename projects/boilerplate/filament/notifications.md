# Boilerplate: Notifications Filament presentation packages

**Composer package:** `module-notifications-filament`
...
This package presents the Notifications core capability through Filament 5. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
