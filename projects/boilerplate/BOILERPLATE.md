...
**Architecture:** Modules conform to [MODULES.md](../../architecture/MODULES.md); API access, integrations, and webhooks conform to [API.md](../../architecture/API.md); foundation UI and assets conform to [THEMES.md](../../architecture/THEMES.md).
**Engineering standards:** Documentation follows [DOCUMENTATION.md](../../architecture/DOCUMENTATION.md); automated testing and coverage follow [TESTING.md](../../architecture/TESTING.md).
