# Boilerplate: Analytics Core domain packages

**Composer package:** `module-analytics-core`
...
This package is the authoritative, presentation-neutral implementation of Analytics Core. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
