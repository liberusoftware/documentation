# Boilerplate: Jetstream Bridge domain packages

**Composer package:** `module-jetstream-bridge`
...
This package is the authoritative, presentation-neutral implementation of Jetstream Bridge. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
