# Boilerplate: Module Manager domain packages

**Composer package:** `module-module-manager`
...
This package is the authoritative, presentation-neutral implementation of Module Manager. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
