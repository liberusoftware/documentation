# Boilerplate: Organizations and Teams domain packages

**Composer package:** `module-organizations-and-teams`
...
This package is the authoritative, presentation-neutral implementation of Organizations and Teams. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
