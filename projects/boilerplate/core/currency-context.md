# Boilerplate: Currency Context domain packages

**Composer package:** `module-currency-context`
...
This package is the authoritative, presentation-neutral implementation of Currency Context. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
