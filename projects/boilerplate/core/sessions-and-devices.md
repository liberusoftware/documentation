# Boilerplate: Sessions and Devices domain packages

**Composer package:** `module-sessions-and-devices`
...
This package is the authoritative, presentation-neutral implementation of Sessions and Devices. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
