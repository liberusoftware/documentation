# Boilerplate: Roles and Permissions domain packages

**Composer package:** `module-roles-and-permissions`
...
This package is the authoritative, presentation-neutral implementation of Roles and Permissions. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
