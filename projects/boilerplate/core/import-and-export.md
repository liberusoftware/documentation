# Boilerplate: Import and Export domain packages

**Composer package:** `module-import-and-export`
...
This package is the authoritative, presentation-neutral implementation of Import and Export. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
