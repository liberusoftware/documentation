# Boilerplate: Identity domain packages

**Composer package:** `module-identity`
...
This package is the authoritative, presentation-neutral implementation of Identity. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
