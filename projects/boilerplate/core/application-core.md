# Boilerplate: Application Core domain packages

**Composer package:** `module-application-core`
...
This package is the authoritative, presentation-neutral implementation of Application Core. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
