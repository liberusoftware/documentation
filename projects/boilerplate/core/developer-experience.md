# Boilerplate: Developer Experience domain packages

**Composer package:** `module-developer-experience`
...
This package is the authoritative, presentation-neutral implementation of Developer Experience. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
