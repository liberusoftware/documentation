# Boilerplate: Files and Media domain packages

**Composer package:** `module-files-and-media`
...
This package is the authoritative, presentation-neutral implementation of Files and Media. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
