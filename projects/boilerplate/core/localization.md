# Boilerplate: Localization domain packages

**Composer package:** `module-localization`
...
This package is the authoritative, presentation-neutral implementation of Localization. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
