# Boilerplate: Observability domain packages

**Composer package:** `module-observability`
...
This package is the authoritative, presentation-neutral implementation of Observability. It owns the domain language, invariants, application actions, read models, policies, persistence, events, jobs, contracts, lifecycle, recovery, data classification, and upgrade behavior for this capability.
