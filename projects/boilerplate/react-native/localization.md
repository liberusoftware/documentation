# Localization domain packages React Native + Expo

**Package:** module-localization-react-native
...
This adapter presents Localization domain packages for the React Native + Expo surface. It owns platform UI, navigation/state integration, device-facing behavior, and client error/recovery mapping; the matching core package remains authoritative for domain rules, persistence, authorization, tenancy, audit, and lifecycle transitions.
