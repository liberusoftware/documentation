# Boilerplate: Google Analytics Vue presentation packages

**Composer package:** `module-google-analytics-vue`
...
This package presents the Google Analytics core capability through Vue. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
