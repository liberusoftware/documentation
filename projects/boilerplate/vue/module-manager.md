# Boilerplate: Module Manager Vue presentation packages

**Composer package:** `module-module-manager-vue`
...
This package presents the Module Manager core capability through Vue. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
