# Boilerplate: Roles and Permissions Vue presentation packages

**Composer package:** `module-roles-and-permissions-vue`
...
This package presents the Roles and Permissions core capability through Vue. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
