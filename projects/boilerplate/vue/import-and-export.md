# Boilerplate: Import and Export Vue presentation packages

**Composer package:** `module-import-and-export-vue`
...
This package presents the Import and Export core capability through Vue. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
