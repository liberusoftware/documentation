# Boilerplate: Analytics Core Nuxt presentation packages

**Composer package:** `module-analytics-core-nuxt`
...
This package presents the Analytics Core core capability through Nuxt 4. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
