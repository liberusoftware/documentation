# Boilerplate: Import and Export Nuxt presentation packages

**Composer package:** `module-import-and-export-nuxt`
...
This package presents the Import and Export core capability through Nuxt 4. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
