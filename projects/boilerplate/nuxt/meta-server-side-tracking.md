# Boilerplate: Meta Server-Side Tracking Nuxt presentation packages

**Composer package:** `module-meta-server-side-tracking-nuxt`
...
This package presents the Meta Server-Side Tracking core capability through Nuxt 4. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
