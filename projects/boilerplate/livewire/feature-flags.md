# Boilerplate: Feature Flags Livewire presentation packages

**Composer package:** `module-feature-flags-livewire`
...
This package presents the Feature Flags core capability through Livewire 4. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
