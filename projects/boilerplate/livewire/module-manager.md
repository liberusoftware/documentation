# Boilerplate: Module Manager Livewire presentation packages

**Composer package:** `module-module-manager-livewire`
...
This package presents the Module Manager core capability through Livewire 4. It owns routes, resources, components, pages, hooks, forms, tables, or client state appropriate to this layer, but does not recreate domain rules, persistence, authorization, or provider integrations.
