# Sandbox And Release Flutter + Dart

**Package:** module-ecommerce-sandbox-and-release-flutter
**Matching core package:** module-ecommerce-sandbox-and-release ([implementation](../core/sandbox-and-release.md))
**Matching API package:** module-ecommerce-sandbox-and-release-api ([contract](../api/sandbox-and-release.md))
...
Test Sandbox And Release API mapping, authorization outcomes, state transitions, lifecycle interruption, permission denial, offline/retry/conflict behavior, accessibility, localization, and signed release builds on supported platforms.

See [Flutter + Dart standard](../../../standards/FLUTTER.md), [mobile architecture](../../../architecture/MOBILE.md), [Flutter + Dart technology](../../../technologies/FLUTTER.md), [core module](../core/sandbox-and-release.md), and [API module](../api/sandbox-and-release.md).
