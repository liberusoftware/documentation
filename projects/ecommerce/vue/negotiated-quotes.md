# Ecommerce: Negotiated Quotes Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-negotiated-quotes-vue-inertia`
**Matching domain module:** `ecommerce-negotiated-quotes`
**Application:** Ecommerce
**Source feature:** [Negotiated Quotes](../features/negotiated-quotes.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/negotiated-quotes.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-negotiated-quotes-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `buyer-seller-negotiation`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `messages`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `line-price-changes`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
