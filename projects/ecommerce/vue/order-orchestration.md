# Ecommerce: Order Orchestration Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-order-orchestration-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/order-orchestration.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-order-orchestration-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `split-routing-decisions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `holds`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `releases`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `backorders`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `partial-operations`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `status-aggregation`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
