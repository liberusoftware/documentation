# Ecommerce: Referrals Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-referrals-vue-inertia`
...
- Register a stable `module-ecommerce-referrals-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `advocate-links-codes`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `referred-customers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `duplicate-fraud-rules`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
