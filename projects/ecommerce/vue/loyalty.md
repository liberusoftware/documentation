# Ecommerce: Loyalty Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-loyalty-vue-inertia`
**Matching domain module:** `ecommerce-loyalty`
**Application:** Ecommerce
**Source feature:** [Loyalty](../features/loyalty.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/loyalty.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- **Earn/redeem:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- **Customer statements:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.

## 3. Vue 3 + Inertia 3 implementation

- Register a stable `module-ecommerce-loyalty-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `programs`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `tiers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `points-ledger`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `earn-redeem`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `referrals`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `fraud-controls`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `liabilities-export`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `customer-statements`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
