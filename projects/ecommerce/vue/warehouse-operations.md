# Ecommerce: Warehouse Operations Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-warehouse-operations-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/warehouse-operations.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-warehouse-operations-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `waves-batches`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `pick-paths`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `packing-stations`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `scans`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `warehouse-system-adapters`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
