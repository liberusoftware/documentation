# Ecommerce: Lots and Serials Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-lots-and-serials-vue-inertia`
**Matching domain module:** `ecommerce-lots-and-serials`
**Application:** Ecommerce
**Source feature:** [Lots and Serials](../features/lots-and-serials.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/lots-and-serials.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-lots-and-serials-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `lot-batch-serial-identity`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `expiry`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `traceability`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `allocation-policy`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `recall`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `warranty-links`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `fulfillment-return-capture`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
