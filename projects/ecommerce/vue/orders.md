# Ecommerce: Orders Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-orders-vue-inertia`
**Matching domain module:** `ecommerce-orders`
**Application:** Ecommerce
**Source feature:** [Orders](../features/orders.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/orders.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-orders-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `immutable-product-price-tax-discount-address-terms-snapshots`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `state-machine`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
