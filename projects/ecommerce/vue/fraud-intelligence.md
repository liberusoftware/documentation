# Ecommerce: Fraud Intelligence Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-fraud-intelligence-vue-inertia`
**Matching domain module:** `ecommerce-fraud-intelligence`
**Application:** Ecommerce
**Source feature:** [Fraud Intelligence](../features/fraud-intelligence.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/fraud-intelligence.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-fraud-intelligence-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `risk-features`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `model-provider-scores`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `decision-explanations`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `drift`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `review-quality`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
