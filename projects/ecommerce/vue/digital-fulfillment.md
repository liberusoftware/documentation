# Ecommerce: Digital Fulfillment Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-digital-fulfillment-vue-inertia`
...
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/digital-fulfillment.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-digital-fulfillment-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `secure-downloads-streams`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `license-key-adapters`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `version-access`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
