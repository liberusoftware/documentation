# Ecommerce: Checkout Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-checkout-vue-inertia`
**Matching domain module:** `ecommerce-checkout`
**Application:** Ecommerce
**Source feature:** [Checkout](../features/checkout.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/checkout.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-ecommerce-checkout-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `contact`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `addresses`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `delivery-pickup`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `order-placement`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
