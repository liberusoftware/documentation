# Ecommerce: Point of Sale Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-ecommerce-point-of-sale-vue-inertia`
**Matching domain module:** `ecommerce-point-of-sale`
**Application:** Ecommerce
**Source feature:** [Point of Sale](../features/point-of-sale.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/point-of-sale.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- **Tenders:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Receipts:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Returns/exchanges:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Holds:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
- **Staff actions:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.

## 3. Vue 3 + Inertia 3 implementation

- Register a stable `module-ecommerce-point-of-sale-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `carts`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `tenders`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `receipts`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `returns-exchanges`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `holds`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `staff-actions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
