# Ecommerce: Shipping React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-shipping-react-inertia`
**Matching domain module:** `ecommerce-shipping`
**Application:** Ecommerce
**Source feature:** [Shipping](../features/shipping.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/shipping.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-shipping-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `free-shipping`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `table-rates`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `carrier-adapters`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
