# Ecommerce: Retail Locations React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-retail-locations-react-inertia`
**Matching domain module:** `ecommerce-retail-locations`
**Application:** Ecommerce
**Source feature:** [Retail Locations](../features/retail-locations.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/retail-locations.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-retail-locations-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `store-hierarchy`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `hours`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `market`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `stock-source`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `staff-assignments`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `fulfillment`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `location-reporting`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
