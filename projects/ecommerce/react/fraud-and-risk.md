# Ecommerce: Fraud and Risk React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-fraud-and-risk-react-inertia`
**Matching domain module:** `ecommerce-fraud-and-risk`
**Application:** Ecommerce
**Source feature:** [Fraud and Risk](../features/fraud-and-risk.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/fraud-and-risk.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-fraud-and-risk-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `velocity`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `identity-device-provider-signals`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `decisions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
