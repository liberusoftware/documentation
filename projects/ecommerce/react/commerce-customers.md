# Ecommerce: Commerce Customers React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-commerce-customers-react-inertia`
**Matching domain module:** `ecommerce-commerce-customers`
**Application:** Ecommerce
**Source feature:** [Commerce Customers](../features/commerce-customers.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/commerce-customers.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-commerce-customers-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `commerce-profiles`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `tax-status`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `crm-identity-references`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
