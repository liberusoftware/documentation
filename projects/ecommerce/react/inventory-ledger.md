# Ecommerce: Inventory Ledger React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-inventory-ledger-react-inertia`
**Matching domain module:** `ecommerce-inventory-ledger`
**Application:** Ecommerce
**Source feature:** [Inventory Ledger](../features/inventory-ledger.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/inventory-ledger.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-inventory-ledger-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `reason-codes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `cost-references`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
