# Ecommerce: Point of Sale React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-point-of-sale-react-inertia`
**Matching domain module:** `ecommerce-point-of-sale`
**Application:** Ecommerce
**Source feature:** [Point of Sale](../features/point-of-sale.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/point-of-sale.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-point-of-sale-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `registers`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `taxes`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `discounts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `tenders`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `receipts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `returns-exchanges`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `holds`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `staff-actions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
