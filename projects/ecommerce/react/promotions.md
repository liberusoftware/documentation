# Ecommerce: Promotions React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-promotions-react-inertia`
**Matching domain module:** `ecommerce-promotions`
**Application:** Ecommerce
**Source feature:** [Promotions](../features/promotions.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/promotions.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-promotions-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `automatic-discounts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `buy-x-get-y`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `bundles`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `free-shipping-gifts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `customer-product-eligibility`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
