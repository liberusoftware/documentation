# Ecommerce: Post-Purchase Experience React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-post-purchase-experience-react-inertia`
...
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/post-purchase-experience.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-post-purchase-experience-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `branded-status`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `instructions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `documents`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `product-registration`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `review-referral-prompts`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `support-links`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `relevant-recommendations`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
