# Ecommerce: Markets React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-ecommerce-markets-react-inertia`
**Matching domain module:** `ecommerce-markets`
**Application:** Ecommerce
**Source feature:** [Markets](../features/markets.md)
**Architecture:** [REACT.md](../ECOMMERCE.md) · [API.md](../ECOMMERCE.md) · [Matching API module](../api/markets.md) · [MODULES.md](../ECOMMERCE.md) · [TESTING.md](../ECOMMERCE.md)
...
- Register a stable `module-ecommerce-markets-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `customer-region-channel-market-definitions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `tax-duty`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `content-theme-references`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
