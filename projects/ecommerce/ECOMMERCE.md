...
**Architecture:** Packages and provider adapters follow [MODULES.md](../../architecture/MODULES.md); storefront APIs, marketplace connectors, and webhooks follow [API.md](../../architecture/API.md); storefront, account, checkout, and POS experiences follow [THEMES.md](../../architecture/THEMES.md).
