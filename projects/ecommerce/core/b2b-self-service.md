# Ecommerce: B2b Self Service Core Module

## Package contract

**Composer package:** `module-ecommerce-b2b-self-service`
**Domain specification:** [B2b Self Service](../features/b2b-self-service.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of B2b Self Service. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
