# Ecommerce: Pos Devices Core Module

## Package contract

**Composer package:** `module-ecommerce-pos-devices`
**Domain specification:** [Pos Devices](../features/pos-devices.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Pos Devices. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
