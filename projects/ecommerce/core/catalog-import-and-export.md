# Ecommerce: Catalog Import And Export Core Module

## Package contract

**Composer package:** `module-ecommerce-catalog-import-and-export`
**Domain specification:** [Catalog Import And Export](../features/catalog-import-and-export.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Catalog Import And Export. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
