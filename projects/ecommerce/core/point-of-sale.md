# Ecommerce: Point Of Sale Core Module

## Package contract

**Composer package:** `module-ecommerce-point-of-sale`
**Domain specification:** [Point Of Sale](../features/point-of-sale.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Point Of Sale. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
