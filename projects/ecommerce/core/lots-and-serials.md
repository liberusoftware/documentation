# Ecommerce: Lots And Serials Core Module

## Package contract

**Composer package:** `module-ecommerce-lots-and-serials`
**Domain specification:** [Lots And Serials](../features/lots-and-serials.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Lots And Serials. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
