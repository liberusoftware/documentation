# Ecommerce: B2b Purchasing Rules Core Module

## Package contract

**Composer package:** `module-ecommerce-b2b-purchasing-rules`
**Domain specification:** [B2b Purchasing Rules](../features/b2b-purchasing-rules.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of B2b Purchasing Rules. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
