# Ecommerce: Post Purchase Experience Core Module

## Package contract

**Composer package:** `module-ecommerce-post-purchase-experience`
**Domain specification:** [Post Purchase Experience](../features/post-purchase-experience.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Post Purchase Experience. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
