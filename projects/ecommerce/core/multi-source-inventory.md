# Ecommerce: Multi Source Inventory Core Module

## Package contract

**Composer package:** `module-ecommerce-multi-source-inventory`
**Domain specification:** [Multi Source Inventory](../features/multi-source-inventory.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Multi Source Inventory. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
