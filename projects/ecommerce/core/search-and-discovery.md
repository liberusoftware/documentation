# Ecommerce: Search And Discovery Core Module

## Package contract

**Composer package:** `module-ecommerce-search-and-discovery`
**Domain specification:** [Search And Discovery](../features/search-and-discovery.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Search And Discovery. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
