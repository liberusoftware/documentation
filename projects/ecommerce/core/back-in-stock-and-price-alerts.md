# Ecommerce: Back In Stock And Price Alerts Core Module

## Package contract

**Composer package:** `module-ecommerce-back-in-stock-and-price-alerts`
**Domain specification:** [Back In Stock And Price Alerts](../features/back-in-stock-and-price-alerts.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Back In Stock And Price Alerts. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
