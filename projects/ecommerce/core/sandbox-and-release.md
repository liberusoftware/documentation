# Ecommerce: Sandbox And Release Core Module

## Package contract

**Composer package:** `module-ecommerce-sandbox-and-release`
**Domain specification:** [Sandbox And Release](../features/sandbox-and-release.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Sandbox And Release. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
