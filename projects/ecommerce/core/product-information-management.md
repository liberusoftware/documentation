# Ecommerce: Product Information Management Core Module

## Package contract

**Composer package:** `module-ecommerce-product-information-management`
**Domain specification:** [Product Information Management](../features/product-information-management.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Product Information Management. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
