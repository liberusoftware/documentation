# Ecommerce: Fraud And Risk Core Module

## Package contract

**Composer package:** `module-ecommerce-fraud-and-risk`
**Domain specification:** [Fraud And Risk](../features/fraud-and-risk.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Fraud And Risk. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
