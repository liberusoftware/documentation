# Ecommerce: Order Tracking Core Module

## Package contract

**Composer package:** `module-ecommerce-order-tracking`
**Domain specification:** [Order Tracking](../features/order-tracking.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Order Tracking. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
