# Ecommerce: Bundles And Kits Core Module

## Package contract

**Composer package:** `module-ecommerce-bundles-and-kits`
**Domain specification:** [Bundles And Kits](../features/bundles-and-kits.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Bundles And Kits. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
