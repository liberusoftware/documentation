# Ecommerce: Delivery Promises Core Module

## Package contract

**Composer package:** `module-ecommerce-delivery-promises`
**Domain specification:** [Delivery Promises](../features/delivery-promises.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Delivery Promises. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
