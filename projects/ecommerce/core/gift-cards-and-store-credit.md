# Ecommerce: Gift Cards And Store Credit Core Module

## Package contract

**Composer package:** `module-ecommerce-gift-cards-and-store-credit`
**Domain specification:** [Gift Cards And Store Credit](../features/gift-cards-and-store-credit.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Gift Cards And Store Credit. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
