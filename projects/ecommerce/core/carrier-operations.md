# Ecommerce: Carrier Operations Core Module

## Package contract

**Composer package:** `module-ecommerce-carrier-operations`
**Domain specification:** [Carrier Operations](../features/carrier-operations.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Carrier Operations. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
