# Ecommerce: Warranty And Claims Core Module

## Package contract

**Composer package:** `module-ecommerce-warranty-and-claims`
**Domain specification:** [Warranty And Claims](../features/warranty-and-claims.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Warranty And Claims. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
