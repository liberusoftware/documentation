# Ecommerce: Pickup And Local Delivery Core Module

## Package contract

**Composer package:** `module-ecommerce-pickup-and-local-delivery`
**Domain specification:** [Pickup And Local Delivery](../features/pickup-and-local-delivery.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Pickup And Local Delivery. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
