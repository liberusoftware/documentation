# Ecommerce: Transfers And Replenishment Core Module

## Package contract

**Composer package:** `module-ecommerce-transfers-and-replenishment`
**Domain specification:** [Transfers And Replenishment](../features/transfers-and-replenishment.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Transfers And Replenishment. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
