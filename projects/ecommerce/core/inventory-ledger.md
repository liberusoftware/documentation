# Ecommerce: Inventory Ledger Core Module

## Package contract

**Composer package:** `module-ecommerce-inventory-ledger`
**Domain specification:** [Inventory Ledger](../features/inventory-ledger.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Inventory Ledger. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
