# Ecommerce: Commissions And Settlements Core Module

## Package contract

**Composer package:** `module-ecommerce-commissions-and-settlements`
**Domain specification:** [Commissions And Settlements](../features/commissions-and-settlements.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Commissions And Settlements. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
