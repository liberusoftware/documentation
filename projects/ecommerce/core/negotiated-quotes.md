# Ecommerce: Negotiated Quotes Core Module

## Package contract

**Composer package:** `module-ecommerce-negotiated-quotes`
**Domain specification:** [Negotiated Quotes](../features/negotiated-quotes.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Negotiated Quotes. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
