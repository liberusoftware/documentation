# Ecommerce: Saved Lists Core Module

## Package contract

**Composer package:** `module-ecommerce-saved-lists`
**Domain specification:** [Saved Lists](../features/saved-lists.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Saved Lists. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
