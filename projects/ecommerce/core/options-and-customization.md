# Ecommerce: Options And Customization Core Module

## Package contract

**Composer package:** `module-ecommerce-options-and-customization`
**Domain specification:** [Options And Customization](../features/options-and-customization.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Options And Customization. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
