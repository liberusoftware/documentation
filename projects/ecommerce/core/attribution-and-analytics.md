# Ecommerce: Attribution And Analytics Core Module

## Package contract

**Composer package:** `module-ecommerce-attribution-and-analytics`
**Domain specification:** [Attribution And Analytics](../features/attribution-and-analytics.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Attribution And Analytics. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
