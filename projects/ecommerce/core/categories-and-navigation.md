# Ecommerce: Categories And Navigation Core Module

## Package contract

**Composer package:** `module-ecommerce-categories-and-navigation`
**Domain specification:** [Categories And Navigation](../features/categories-and-navigation.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Categories And Navigation. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
