# Ecommerce: Offline Pos Core Module

## Package contract

**Composer package:** `module-ecommerce-offline-pos`
**Domain specification:** [Offline Pos](../features/offline-pos.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Offline Pos. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
