# Ecommerce: Digital Fulfillment Core Module

## Package contract

**Composer package:** `module-ecommerce-digital-fulfillment`
**Domain specification:** [Digital Fulfillment](../features/digital-fulfillment.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Digital Fulfillment. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
