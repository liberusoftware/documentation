# Ecommerce: Customer Service Workspace Core Module

## Package contract

**Composer package:** `module-ecommerce-customer-service-workspace`
**Domain specification:** [Customer Service Workspace](../features/customer-service-workspace.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Customer Service Workspace. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
