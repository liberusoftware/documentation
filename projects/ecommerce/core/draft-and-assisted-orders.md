# Ecommerce: Draft And Assisted Orders Core Module

## Package contract

**Composer package:** `module-ecommerce-draft-and-assisted-orders`
**Domain specification:** [Draft And Assisted Orders](../features/draft-and-assisted-orders.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Draft And Assisted Orders. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
