# Ecommerce: Merchandising Intelligence Core Module

## Package contract

**Composer package:** `module-ecommerce-merchandising-intelligence`
**Domain specification:** [Merchandising Intelligence](../features/merchandising-intelligence.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Merchandising Intelligence. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
