# Ecommerce: Bookings And Appointments Core Module

## Package contract

**Composer package:** `module-ecommerce-bookings-and-appointments`
**Domain specification:** [Bookings And Appointments](../features/bookings-and-appointments.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Bookings And Appointments. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
