# Ecommerce: Membership Commerce

## Canonical independent module specification

**Domain module:** `module-ecommerce-membership-commerce`
...
The Membership Commerce module owns Membership products, access grants, tiers, bundles, renewal references, member pricing/content, and portal integration. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Membership products:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Member pricing/content:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Portal integration:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-ecommerce-membership-commerce-filament`, `module-ecommerce-membership-commerce-livewire`, and `module-ecommerce-membership-commerce-api`.
...
- Verify membership products across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify member pricing/content across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify portal integration across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
