...
**Domain module:** `module-ecommerce-personalization`
...
The Personalization module owns Audience/market/customer context, catalog/content/offer variants, eligibility, consent, fallback, holdouts, and decision history. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.

## 2. Full feature scope

- **Audience/market/customer context:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Catalog/content/offer variants:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-ecommerce-personalization-filament`, `module-ecommerce-personalization-livewire`, and `module-ecommerce-personalization-api`.
...
- Verify audience/market/customer context across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify catalog/content/offer variants across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
