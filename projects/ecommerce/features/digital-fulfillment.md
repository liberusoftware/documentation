# Ecommerce: Digital Fulfillment

## Canonical independent module specification

**Domain module:** `module-ecommerce-digital-fulfillment`
...
The Digital Fulfillment module owns Entitlements, secure downloads/streams, limits, expiry, license-key adapters, version access, revocation, and evidence. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Secure downloads/streams:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **License-key adapters:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
- **Version access:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-ecommerce-digital-fulfillment-filament`, `module-ecommerce-digital-fulfillment-livewire`, and `module-ecommerce-digital-fulfillment-api`.
...
- Verify secure downloads/streams across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify license-key adapters across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
- Verify version access across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
