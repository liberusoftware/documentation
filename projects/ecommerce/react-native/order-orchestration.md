# Order Orchestration React Native + Expo

**Package:** module-ecommerce-order-orchestration-react-native
**Matching core package:** module-ecommerce-order-orchestration ([implementation](../core/order-orchestration.md))
**Matching API package:** module-ecommerce-order-orchestration-api ([contract](../api/order-orchestration.md))

## Implementation plan

This adapter presents Order Orchestration for the React Native + Expo surface. It owns platform UI, navigation/state integration, device-facing behavior, and client error/recovery mapping; the matching core package remains authoritative for domain rules, persistence, authorization, tenancy, audit, and lifecycle transitions.
...
Test Order Orchestration API mapping, authorization outcomes, state transitions, lifecycle interruption, permission denial, offline/retry/conflict behavior, accessibility, localization, and signed release builds on supported platforms.

See [React Native + Expo standard](../../../standards/REACT-NATIVE.md), [mobile architecture](../../../architecture/MOBILE.md), [React Native + Expo technology](../../../technologies/REACT-NATIVE.md), [core module](../core/order-orchestration.md), and [API module](../api/order-orchestration.md).
