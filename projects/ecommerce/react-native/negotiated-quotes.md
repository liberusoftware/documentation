# Negotiated Quotes React Native + Expo

**Package:** module-ecommerce-negotiated-quotes-react-native
**Matching core package:** module-ecommerce-negotiated-quotes ([implementation](../core/negotiated-quotes.md))
**Matching API package:** module-ecommerce-negotiated-quotes-api ([contract](../api/negotiated-quotes.md))

## Implementation plan

This adapter presents Negotiated Quotes for the React Native + Expo surface. It owns platform UI, navigation/state integration, device-facing behavior, and client error/recovery mapping; the matching core package remains authoritative for domain rules, persistence, authorization, tenancy, audit, and lifecycle transitions.
...
Test Negotiated Quotes API mapping, authorization outcomes, state transitions, lifecycle interruption, permission denial, offline/retry/conflict behavior, accessibility, localization, and signed release builds on supported platforms.

See [React Native + Expo standard](../../../standards/REACT-NATIVE.md), [mobile architecture](../../../architecture/MOBILE.md), [React Native + Expo technology](../../../technologies/REACT-NATIVE.md), [core module](../core/negotiated-quotes.md), and [API module](../api/negotiated-quotes.md).
