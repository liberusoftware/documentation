...
**Architecture:** Packages and extensions follow [MODULES.md](../../architecture/MODULES.md); headless delivery, federation, connectors, and webhooks follow [API.md](../../architecture/API.md); rendering, themes, layouts, and assets follow [THEMES.md](../../standards/THEMES.md).
