...
**Architecture:** Packages and extensions follow [MODULES.md](../../architecture/MODULES.md); headless delivery, federation, connectors, and webhooks follow [API.md](../../architecture/API.md); rendering, themes, layouts, and assets follow [THEMES.md](../../architecture/THEMES.md).

**Foundation:** Consume relevant modules from [BOILERPLATE.md](../boilerplate/BOILERPLATE.md). Identity, teams, authorization, localization primitives, files, audit, queues, integrations, and observability are not reimplemented here.
