# CMS: Editorial Workflow Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-cms-editorial-workflow-vue-inertia`
**Matching domain module:** `cms-editorial-workflow`
**Application:** CMS
**Source feature:** [Editorial Workflow](../features/editorial-workflow.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/editorial-workflow.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-cms-editorial-workflow-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `configurable-states-transitions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
