# CMS: Revisions Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-cms-revisions-vue-inertia`
**Matching domain module:** `cms-revisions`
**Application:** CMS
**Source feature:** [Revisions](../features/revisions.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/revisions.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-cms-revisions-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `immutable-revisions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `autosave`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `compare`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `published-versus-working-copies`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
