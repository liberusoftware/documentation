# CMS: Rich Text Editor Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-cms-rich-text-editor-vue-inertia`
**Matching domain module:** `cms-rich-text-editor`
**Application:** CMS
**Source feature:** [Rich Text Editor](../features/rich-text-editor.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/rich-text-editor.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-cms-rich-text-editor-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `semantic-rich-text`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `embeds`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `code`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `paste-cleanup`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `accessibility-hints`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `formats`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `sanitization`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
