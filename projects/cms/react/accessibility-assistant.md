# CMS: Accessibility Assistant React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-accessibility-assistant-react-inertia`
...
**Architecture:** [REACT.md](../CMS.md) · [API.md](../CMS.md) · [Matching API module](../api/accessibility-assistant.md) · [MODULES.md](../CMS.md) · [TESTING.md](../CMS.md)
...
- Register a stable `module-cms-accessibility-assistant-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `authoring-checks-for-headings`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `alternatives`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `contrast-metadata`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
