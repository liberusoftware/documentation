# CMS: Metadata React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-cms-metadata-react-inertia`
**Matching domain module:** `cms-metadata`
**Application:** CMS
**Source feature:** [Metadata](../features/metadata.md)
**Architecture:** [REACT.md](../CMS.md) · [API.md](../CMS.md) · [Matching API module](../api/metadata.md) · [MODULES.md](../CMS.md) · [TESTING.md](../CMS.md)
...
- Register a stable `module-cms-metadata-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `arbitrary-governed-metadata`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `indexing`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `api-exposure`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
