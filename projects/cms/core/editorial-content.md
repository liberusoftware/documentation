# Cms: Editorial Content Core Module

## Package contract

**Composer package:** `module-cms-editorial-content`
**Domain specification:** [Editorial Content](../features/editorial-content.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Editorial Content. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
