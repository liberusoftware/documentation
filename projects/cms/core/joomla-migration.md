# Cms: Joomla Migration Core Module

## Package contract

**Composer package:** `module-cms-joomla-migration`
**Domain specification:** [Joomla Migration](../features/joomla-migration.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Joomla Migration. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
