# Cms: Polls And Surveys Core Module

## Package contract

**Composer package:** `module-cms-polls-and-surveys`
**Domain specification:** [Polls And Surveys](../features/polls-and-surveys.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Polls And Surveys. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
