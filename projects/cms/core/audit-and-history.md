# Cms: Audit And History Core Module

## Package contract

**Composer package:** `module-cms-audit-and-history`
**Domain specification:** [Audit And History](../features/audit-and-history.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Audit And History. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
