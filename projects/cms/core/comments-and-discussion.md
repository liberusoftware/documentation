# Cms: Comments And Discussion Core Module

## Package contract

**Composer package:** `module-cms-comments-and-discussion`
**Domain specification:** [Comments And Discussion](../features/comments-and-discussion.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Comments And Discussion. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
