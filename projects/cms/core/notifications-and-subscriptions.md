# Cms: Notifications And Subscriptions Core Module

## Package contract

**Composer package:** `module-cms-notifications-and-subscriptions`
**Domain specification:** [Notifications And Subscriptions](../features/notifications-and-subscriptions.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Notifications And Subscriptions. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
