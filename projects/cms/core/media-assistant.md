# Cms: Media Assistant Core Module

## Package contract

**Composer package:** `module-cms-media-assistant`
**Domain specification:** [Media Assistant](../features/media-assistant.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Media Assistant. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
