# Cms: Content Templates Core Module

## Package contract

**Composer package:** `module-cms-content-templates`
**Domain specification:** [Content Templates](../features/content-templates.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Content Templates. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
