# Cms: Content Integrity Core Module

## Package contract

**Composer package:** `module-cms-content-integrity`
**Domain specification:** [Content Integrity](../features/content-integrity.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Content Integrity. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
