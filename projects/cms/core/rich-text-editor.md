# Cms: Rich Text Editor Core Module

## Package contract

**Composer package:** `module-cms-rich-text-editor`
**Domain specification:** [Rich Text Editor](../features/rich-text-editor.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Rich Text Editor. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
