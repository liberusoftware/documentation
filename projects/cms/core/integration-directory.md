# Cms: Integration Directory Core Module

## Package contract

**Composer package:** `module-cms-integration-directory`
**Domain specification:** [Integration Directory](../features/integration-directory.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Integration Directory. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
