# Cms: Cache And Performance Core Module

## Package contract

**Composer package:** `module-cms-cache-and-performance`
**Domain specification:** [Cache And Performance](../features/cache-and-performance.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Cache And Performance. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
