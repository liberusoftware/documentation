# Cms: Knowledge Base Core Module

## Package contract

**Composer package:** `module-cms-knowledge-base`
**Domain specification:** [Knowledge Base](../features/knowledge-base.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Knowledge Base. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
