# Cms: Backup And Restore Core Module

## Package contract

**Composer package:** `module-cms-backup-and-restore`
**Domain specification:** [Backup And Restore](../features/backup-and-restore.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Backup And Restore. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
