# Cms: Views And Query Builder Core Module

## Package contract

**Composer package:** `module-cms-views-and-query-builder`
**Domain specification:** [Views And Query Builder](../features/views-and-query-builder.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Views And Query Builder. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
