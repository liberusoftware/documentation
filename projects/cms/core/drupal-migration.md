# Cms: Drupal Migration Core Module

## Package contract

**Composer package:** `module-cms-drupal-migration`
**Domain specification:** [Drupal Migration](../features/drupal-migration.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Drupal Migration. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
