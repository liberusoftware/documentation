# Cms: Editorial Workflow Core Module

## Package contract

**Composer package:** `module-cms-editorial-workflow`
**Domain specification:** [Editorial Workflow](../features/editorial-workflow.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Editorial Workflow. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
