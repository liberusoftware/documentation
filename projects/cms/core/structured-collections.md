# Cms: Structured Collections Core Module

## Package contract

**Composer package:** `module-cms-structured-collections`
**Domain specification:** [Structured Collections](../features/structured-collections.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Structured Collections. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
