# Cms: Hook And Event Sdk Core Module

## Package contract

**Composer package:** `module-cms-hook-and-event-sdk`
**Domain specification:** [Hook And Event Sdk](../features/hook-and-event-sdk.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Hook And Event Sdk. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
