# Cms: Offline And Pwa Core Module

## Package contract

**Composer package:** `module-cms-offline-and-pwa`
**Domain specification:** [Offline And Pwa](../features/offline-and-pwa.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Offline And Pwa. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
