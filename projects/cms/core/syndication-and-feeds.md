# Cms: Syndication And Feeds Core Module

## Package contract

**Composer package:** `module-cms-syndication-and-feeds`
**Domain specification:** [Syndication And Feeds](../features/syndication-and-feeds.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Syndication And Feeds. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
