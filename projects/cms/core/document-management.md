# Cms: Document Management Core Module

## Package contract

**Composer package:** `module-cms-document-management`
**Domain specification:** [Document Management](../features/document-management.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Document Management. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
