# Cms: Translation Assistant Core Module

## Package contract

**Composer package:** `module-cms-translation-assistant`
**Domain specification:** [Translation Assistant](../features/translation-assistant.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Translation Assistant. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
