# Cms: Content Governance Core Module

## Package contract

**Composer package:** `module-cms-content-governance`
**Domain specification:** [Content Governance](../features/content-governance.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Content Governance. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
