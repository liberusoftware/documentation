# Cms: Headless Api Core Module

## Package contract

**Composer package:** `module-cms-headless-api`
**Domain specification:** [Headless Api](../features/headless-api.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Headless Api. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
