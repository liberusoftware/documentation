# Automation: Prompt Registry Core Module

## Package contract

**Composer package:** `module-automation-prompt-registry`
**Domain specification:** [Prompt Registry](../features/prompt-registry.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Prompt Registry. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
