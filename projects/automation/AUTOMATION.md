...
**Architecture:** Implement every capability as modules conforming to [MODULES.md](../../architecture/MODULES.md); APIs, connectors, triggers, and webhooks follow [API.md](../../architecture/API.md); presentation follows [THEMES.md](../../architecture/THEMES.md).
