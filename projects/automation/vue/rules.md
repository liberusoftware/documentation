# Automation: Rules Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-automation-rules-vue-inertia`
**Matching domain module:** `automation-rules`
**Application:** Automation
**Source feature:** [Rules](../features/rules.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/rules.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-automation-rules-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `typed-conditions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `expressions`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `reusable-decision-tables`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
