# Maintenance: Preventative Maintenance Core Module

## Package contract

**Composer package:** `module-maintenance-preventative-maintenance`
**Domain specification:** [Preventative Maintenance](../features/preventative-maintenance.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Preventative Maintenance. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
