# Maintenance: Labor And Time Core Module

## Package contract

**Composer package:** `module-maintenance-labor-and-time`
**Domain specification:** [Labor And Time](../features/labor-and-time.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Labor And Time. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
