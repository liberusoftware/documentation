...
**Domain module:** `module-maintenance-procurement`
...
The Procurement module owns Suppliers, requests, approvals, purchase orders, receipts, returns, and cost allocation. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- Provide matching optional presentation packages only when required: `module-maintenance-procurement-filament`, `module-maintenance-procurement-livewire`, and `module-maintenance-procurement-api`.
