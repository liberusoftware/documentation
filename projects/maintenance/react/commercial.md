# Maintenance: Commercial React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-maintenance-commercial-react-inertia`
**Matching domain module:** `maintenance-commercial`
**Application:** Maintenance
**Source feature:** [Commercial](../features/commercial.md)
**Architecture:** [REACT.md](../MAINTENANCE.md) · [API.md](../MAINTENANCE.md) · [Matching API module](../api/commercial.md) · [MODULES.md](../MAINTENANCE.md) · [TESTING.md](../MAINTENANCE.md)
...
- Register a stable `module-maintenance-commercial-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `covered-assets-services`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `billable-lines`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
