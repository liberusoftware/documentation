# Maintenance: Work Orders React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-maintenance-work-orders-react-inertia`
**Matching domain module:** `maintenance-work-orders`
**Application:** Maintenance
**Source feature:** [Work Orders](../features/work-orders.md)
**Architecture:** [REACT.md](../MAINTENANCE.md) · [API.md](../MAINTENANCE.md) · [Matching API module](../api/work-orders.md) · [MODULES.md](../MAINTENANCE.md) · [TESTING.md](../MAINTENANCE.md)
...
- Register a stable `module-maintenance-work-orders-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `triage`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `status-machine`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
