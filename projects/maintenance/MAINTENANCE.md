...
**Architecture:** Modules follow [MODULES.md](../../architecture/MODULES.md); field, customer, provider, and device APIs follow [API.md](../../architecture/API.md); office, engineer, and customer experiences follow [THEMES.md](../../architecture/THEMES.md).
