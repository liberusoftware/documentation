# Maintenance: Labor and Time Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-maintenance-labor-and-time-vue-inertia`
**Matching domain module:** `maintenance-labor-and-time`
**Application:** Maintenance
**Source feature:** [Labor and Time](../features/labor-and-time.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/labor-and-time.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-maintenance-labor-and-time-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `engineer-skills`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `attendance`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `time-entries`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
