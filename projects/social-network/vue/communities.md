# Social Network: Communities Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-social-network-communities-vue-inertia`
...
- Register a stable `module-social-network-communities-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `groups-pages`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `files`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
