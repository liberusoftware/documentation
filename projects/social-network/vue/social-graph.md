# Social Network: Social Graph Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-social-network-social-graph-vue-inertia`
**Matching domain module:** `social-network-social-graph`
**Application:** Social Network
**Source feature:** [Social Graph](../features/social-graph.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/social-graph.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-social-network-social-graph-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `follow-friend-models`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `requests`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `lists`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `relationship-visibility`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
