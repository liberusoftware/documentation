# Social Network: Federation Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-social-network-federation-vue-inertia`
**Matching domain module:** `social-network-federation`
**Application:** Social Network
**Source feature:** [Federation](../features/federation.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/federation.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-social-network-federation-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `activitypub-identities`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `inbox-outbox`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
