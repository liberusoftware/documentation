...
**Architecture:** Modules follow [MODULES.md](../../architecture/MODULES.md); public, application, moderation, and federation APIs follow [API.md](../../architecture/API.md); community experiences and branding follow [THEMES.md](../../architecture/THEMES.md).
