# Social Network: Social Graph Core Module

## Package contract

**Composer package:** `module-social-network-social-graph`
**Domain specification:** [Social Graph](../features/social-graph.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Social Graph. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
