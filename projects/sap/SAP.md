...
**Architecture:** This product composes modules under [MODULES.md](../../architecture/MODULES.md); enterprise APIs, integrations, and events follow [API.md](../../architecture/API.md); all experiences follow [THEMES.md](../../architecture/THEMES.md). [LIBERU.md](../../architecture/LIBERU.md) remains the platform overview.
