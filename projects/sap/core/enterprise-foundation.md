# Sap: Enterprise Foundation Core Module

## Package contract

**Composer package:** `module-sap-enterprise-foundation`
**Domain specification:** [Enterprise Foundation](../features/enterprise-foundation.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Enterprise Foundation. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
