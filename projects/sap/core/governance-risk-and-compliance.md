# Sap: Governance Risk And Compliance Core Module

## Package contract

**Composer package:** `module-sap-governance-risk-and-compliance`
**Domain specification:** [Governance Risk And Compliance](../features/governance-risk-and-compliance.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Governance Risk And Compliance. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
