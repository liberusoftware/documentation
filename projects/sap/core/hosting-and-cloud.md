# Sap: Hosting And Cloud Core Module

## Package contract

**Composer package:** `module-sap-hosting-and-cloud`
**Domain specification:** [Hosting And Cloud](../features/hosting-and-cloud.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Hosting And Cloud. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
