# Sap: Product And Engineering Core Module

## Package contract

**Composer package:** `module-sap-product-and-engineering`
**Domain specification:** [Product And Engineering](../features/product-and-engineering.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Product And Engineering. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
