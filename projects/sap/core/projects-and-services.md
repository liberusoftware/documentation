# Sap: Projects And Services Core Module

## Package contract

**Composer package:** `module-sap-projects-and-services`
**Domain specification:** [Projects And Services](../features/projects-and-services.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Projects And Services. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
