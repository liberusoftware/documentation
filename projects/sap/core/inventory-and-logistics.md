# Sap: Inventory And Logistics Core Module

## Package contract

**Composer package:** `module-sap-inventory-and-logistics`
**Domain specification:** [Inventory And Logistics](../features/inventory-and-logistics.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Inventory And Logistics. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
