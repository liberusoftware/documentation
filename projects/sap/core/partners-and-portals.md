# Sap: Partners And Portals Core Module

## Package contract

**Composer package:** `module-sap-partners-and-portals`
**Domain specification:** [Partners And Portals](../features/partners-and-portals.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Partners And Portals. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
