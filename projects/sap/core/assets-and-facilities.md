# Sap: Assets And Facilities Core Module

## Package contract

**Composer package:** `module-sap-assets-and-facilities`
**Domain specification:** [Assets And Facilities](../features/assets-and-facilities.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Assets And Facilities. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
