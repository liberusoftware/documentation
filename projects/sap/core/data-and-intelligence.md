# Sap: Data And Intelligence Core Module

## Package contract

**Composer package:** `module-sap-data-and-intelligence`
**Domain specification:** [Data And Intelligence](../features/data-and-intelligence.md)
**Target:** Laravel 13, PHP 8.5, Composer 2, Pest 5

This package is the authoritative, provider-neutral implementation of Data And Intelligence. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
