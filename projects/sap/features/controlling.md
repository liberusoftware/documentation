...
**Domain module:** `module-sap-controlling`
**Application:** SAP  
...
The Controlling module owns Cost/profit centers, internal orders, allocation, planning, variance, unit economics, and profitability. It is the authoritative boundary for this capability and must remain independently installable, testable, versioned, enabled, and reusable across compatible Liberu applications.
...
- **Internal orders:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- **Unit economics:** implement the complete lifecycle, validation, permissions, failure handling, audit evidence, and operator/user feedback required by this capability.
...
- Provide matching optional presentation packages only when required: `module-sap-controlling-filament`, `module-sap-controlling-livewire`, and `module-sap-controlling-api`.
...
- Verify internal orders across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
...
- Verify unit economics across allowed, denied, invalid, duplicate, concurrent, partial-failure, recovery, and tenant-isolation paths where applicable.
