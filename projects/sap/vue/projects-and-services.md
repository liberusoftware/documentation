# SAP: Projects and Services Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-sap-projects-and-services-vue-inertia`
**Matching domain module:** `sap-projects-and-services`
**Application:** SAP
**Source feature:** [Projects and Services](../features/projects-and-services.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/projects-and-services.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-sap-projects-and-services-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `portfolios`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `time`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
