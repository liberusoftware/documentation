# SAP: Partners and Portals Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-sap-partners-and-portals-vue-inertia`
**Matching domain module:** `sap-partners-and-portals`
**Application:** SAP
**Source feature:** [Partners and Portals](../features/partners-and-portals.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/partners-and-portals.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-sap-partners-and-portals-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `resellers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `partners`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `customers`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `employees`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `delegated-self-service`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
