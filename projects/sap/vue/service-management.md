# SAP: Service Management Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-sap-service-management-vue-inertia`
**Matching domain module:** `sap-service-management`
**Application:** SAP
**Source feature:** [Service Management](../features/service-management.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/service-management.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-sap-service-management-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `problems`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `changes`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `knowledge`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `cmdb`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `sla`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `field-service`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
