# SAP: Controlling Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-sap-controlling-vue-inertia`
**Matching domain module:** `sap-controlling`
**Application:** SAP
**Source feature:** [Controlling](../features/controlling.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/controlling.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- **Internal orders:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- **Unit economics:** page, component, hook, form, and failure-state behavior for this module's authorized workflow.
...
- Register a stable `module-sap-controlling-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `internal-orders`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `unit-economics`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
