# SAP: Sales and CRM Vue + Inertia

## Canonical one-to-one Vue/Inertia implementation

**Package:** `module-sap-sales-and-crm-vue-inertia`
**Matching domain module:** `sap-sales-and-crm`
**Application:** SAP
**Source feature:** [Sales and CRM](../features/sales-and-crm.md)
**Architecture:** [VUE-INERTIA.md](../../../architecture/VUE-INERTIA.md) · [API.md](../../../architecture/API.md) · [Matching API module](../api/sales-and-crm.md) · [MODULES.md](../../../architecture/MODULES.md) · [TESTING.md](../../../architecture/TESTING.md)
...
- Register a stable `module-sap-sales-and-crm-vue-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `leads`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
...
- `customer-success`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
- `communications`: map the matching API query/action to a focused Vue page, component, hook, or Inertia form.
