# SAP: Procurement React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-sap-procurement-react-inertia`
**Matching domain module:** `sap-procurement`
**Application:** SAP
**Source feature:** [Procurement](../features/procurement.md)
**Architecture:** [REACT.md](../SAP.md) · [API.md](../SAP.md) · [Matching API module](../api/procurement.md) · [MODULES.md](../SAP.md) · [TESTING.md](../SAP.md)
...
- Register a stable `module-sap-procurement-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `requisitions`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
- `sourcing`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `spend-analysis`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
