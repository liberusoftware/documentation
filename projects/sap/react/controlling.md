# SAP: Controlling React + Inertia

## Canonical one-to-one React/Inertia implementation

**Package:** `module-sap-controlling-react-inertia`
**Matching domain module:** `sap-controlling`
**Application:** SAP
**Source feature:** [Controlling](../features/controlling.md)
**Architecture:** [REACT.md](../SAP.md) · [API.md](../SAP.md) · [Matching API module](../api/controlling.md) · [MODULES.md](../SAP.md) · [TESTING.md](../SAP.md)
...
- Register a stable `module-sap-controlling-react-inertia` package and expose only explicitly prefixed public exports; applications compose it explicitly.
...
- `internal-orders`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
...
- `unit-economics`: map the matching API query/action to a focused React page, component, hook, or Inertia form.
