...
Official references: [Laravel database](https://laravel.com/docs/13.x/database), [MySQL](https://dev.mysql.com/doc/), [PostgreSQL](https://www.postgresql.org/docs/), and [SQLite](https://www.sqlite.org/docs.html).
