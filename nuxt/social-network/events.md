# Social Network: Events Nuxt

## Canonical one-to-one Nuxt 4 implementation

**Nuxt package:** `module-social-network-events-nuxt`
**Matching domain module:** `social-network-events`
**Application:** Social Network
**Source feature:** [Events](../../features/social-network/events.md)
**Architecture:** [NUXT.md](../../NUXT.md) · [API.md](../../API.md) · [Matching API module](../../api/social-network/events.md) · [MODULES.md](../../MODULES.md) · [TESTING.md](../../TESTING.md)

## 1. Purpose and ownership

This optional Nuxt 4 presentation package presents exactly one matching API module. It contributes reusable pages, layouts, components, composables, typed API clients, and actions to application-owned Nuxt applications while delegating authorization, validation, team context, persistence, and business rules to the `social-network-events` public API boundary. It must not contain another module's UI or depend on application `App\` classes.
...
- Register a stable `module-social-network-events-nuxt` Nuxt module or layer and expose only prefixed exports from this package; applications compose it explicitly.
